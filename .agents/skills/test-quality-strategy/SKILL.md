...
| [references/test-plan-headers.md](references/test-plan-headers.md) | Read before creating, changing, or reviewing a test file that matches a structured test-plan header trigger. Skip for tiny one-case unit tests and files that do not match a trigger. |
