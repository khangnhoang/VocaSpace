...
Read only the references whose conditions match the requested browser work:

| Resource | Read condition |
| --- | --- |
| [references/playwright-tests.md](references/playwright-tests.md) | Read before running, debugging, or changing Playwright tests. |
| [references/request-mocking.md](references/request-mocking.md) | Read before intercepting or mocking browser network requests. |
| [references/running-code.md](references/running-code.md) | Read before using `run-code` for Playwright API work that the core commands do not cover. |
| [references/session-management.md](references/session-management.md) | Read before using named, persistent, attached, or multiple browser sessions. |
| [references/storage-state.md](references/storage-state.md) | Read before saving, loading, inspecting, or changing cookies, local storage, or session storage. |
| [references/test-generation.md](references/test-generation.md) | Read before planning, generating, or healing Playwright tests. |
| [references/tracing.md](references/tracing.md) | Read before recording or inspecting Playwright traces. |
| [references/video-recording.md](references/video-recording.md) | Read before recording or annotating browser video. |
| [references/pr-attachments.md](references/pr-attachments.md) | Read before attaching browser screenshots, videos, or test artifacts to a pull request. |
| [references/element-attributes.md](references/element-attributes.md) | Read when the task requires inspecting element attributes that are not available in the normal snapshot. |

Read every matching reference when conditions overlap. Skip all unmatched references; the core commands below are sufficient for ordinary open, navigate, snapshot, interact, inspect, and close flows.
...
### Snapshot
Snapshot file: `.playwright-cli/page-2026-02-14T19-22-42-679Z.yml`
```
