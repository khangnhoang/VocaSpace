...
values
  ...
  (
    ...
    'B2 QA - Bắt đầu từ nền tảng',
    'b2-qa-not-started-foundation',
    'Course not-started deterministic để kiểm tra pagination và CTA bắt đầu học.',
    129000,
    'published',
    107,
  ...
  (
    ...
    'B2 QA - Thực hành theo tình huống',
    'b2-qa-not-started-situations',
    'Course not-started deterministic thứ hai để đẩy danh sách sang trang tiếp theo.',
    139000,
    'published',
    108,
    '2026-07-01 08:00:00+00',
  ...
  (
    ...
    'B2 QA - Khóa học chưa bắt đầu với tiêu đề rất dài để kiểm tra giới hạn hai dòng trên Course Row ở các kích thước màn hình',
    'b2-qa-not-started-long-title',
    'Course not-started deterministic có title dài và thumbnail null để kiểm tra truncation cùng fallback.',
    149000,
    'published',
    109,
...
values
  ...
  (
    'b2100000-0000-4000-8000-000000000071',
    'b2000000-0000-4000-8000-000000000007',
    'B2 QA - Nền tảng',
    1,
    '2026-07-05 07:00:00+00',
    '2026-07-05 07:00:00+00',
    null
  ),
  (
    'b2100000-0000-4000-8000-000000000081',
    'b2000000-0000-4000-8000-000000000008',
    'B2 QA - Tình huống',
    1,
  ...
  (
    'b2100000-0000-4000-8000-000000000091',
    'b2000000-0000-4000-8000-000000000009',
    'B2 QA - Tiêu đề dài',
    1,
...
values
  ...
  (
    'b2200000-0000-4000-8000-000000000711',
    'b2000000-0000-4000-8000-000000000007',
    'b2100000-0000-4000-8000-000000000071',
    'Bài mở đầu nền tảng',
    'b2-qa-not-started-foundation-topic',
    'Topic published đầu tiên cho CTA bắt đầu học của fixture pagination.',
    'published',
    1,
  ...
  (
    ...
    'b2000000-0000-4000-8000-000000000008',
    'b2100000-0000-4000-8000-000000000081',
    'Bài mở đầu tình huống',
    'b2-qa-not-started-situations-topic',
    'Topic published đầu tiên cho course not-started thứ hai.',
    'published',
    1,
  ...
  (
    ...
    'b2000000-0000-4000-8000-000000000009',
    'b2100000-0000-4000-8000-000000000091',
    'Bài mở đầu cho khóa học có tiêu đề dài',
    'b2-qa-not-started-long-title-topic',
    'Topic published đầu tiên cho fixture title dài và thumbnail fallback.',
    'published',
    1,
...
values
  ...
  (
    'b2300000-0000-4000-8000-000000000007',
    '33333333-3333-4333-8333-333333333333',
    'b2000000-0000-4000-8000-000000000007',
    '2026-07-10 07:00:00+00'
  ),
  (
    'b2300000-0000-4000-8000-000000000008',
    '33333333-3333-4333-8333-333333333333',
    'b2000000-0000-4000-8000-000000000008',
    '2026-07-10 08:00:00+00'
  ),
  (
    'b2300000-0000-4000-8000-000000000009',
    '33333333-3333-4333-8333-333333333333',
    'b2000000-0000-4000-8000-000000000009',
