...
const courseStats = [
  {
    ...
    value: "8",
    description: "Chương học (Chapters)",
    icon: <Layers size={24} />,
    color: "text-blue-600",
  ...
  },
  {
    ...
    value: "24",
    description: "Bài học chi tiết (Topics)",
  ...
  },
  {
    ...
    title: "Thẻ từ vựng",
    value: "350",
    description: "Flashcards đã tạo (Cards)",
  ...
  },
  {
    ...
    title: "Bài tập TOEIC",
    value: "120",
    description: "Câu hỏi trắc nghiệm (Questions)",
      ...
      <div className="mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          ...
          <Button
            ...
            className="bg-[#3B82F6] hover:bg-[#2563EB] text-white font-bold h-12 px-6 rounded-xl shadow-md"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {courseStats.map((stat) => (
            <div
              key={stat.id}
              className={`flex items-center gap-4 p-5 bg-white rounded-2xl border shadow-sm transition-all hover:shadow-md hover:-translate-y-1 ${stat.borderColor}`}
            >
              {/* Cột Icon */}
