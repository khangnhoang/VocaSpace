...
- Authority: this owner task covers only the bounded CP9 thread-start diagnostic R3 backward-compatibility correction, deterministic fake regressions, terminal self-review and exactly one local correction commit. Real App Server/thread/turn/model/provider calls, pilot retry/resume, new preparation/run/authority/probe, push, PR/CI/merge/deploy, history rewrite and CP10 remain unauthorized.
