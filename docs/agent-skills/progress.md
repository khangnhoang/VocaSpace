...
**ASM-PR1, ASM-PR2A–ASM-PR2C, ASM-PR3, ASM-PR4, ASM-PR5A và ASM-PR5B đã merge; PR #73 merged ASM-PR5B tại `effb5571955aa09b714e97b7162a6bb3bed0bca4`. Current workstream là Agent Skill Eval Harness hardening trên `refactor/agent-skill-eval-harness`; Stage 1 (`CP1–CP4`) và Stage 2 (`CP5–CP7`) đã completed/delivered, còn Stage 3 CP8A đã completed tại terminal correction review `0 Critical / 0 Required`. CP8A certification chỉ dùng deterministic mocked App Server transport; live model/helper/evaluator/provider calls bằng `0`. CP8B+ vẫn pending explicit owner authorization và exact latest delivery state thuộc Git evidence.**
...
- Authority: no standing Stage 1–2 authority remains. The task-local CP8A correction permits exactly one conditional local checkpoint but creates no standing authority; exact consumption belongs to Git evidence. No push, CP8B+, live-call, PR/CI/merge/deploy or history-rewrite authority carries forward.
