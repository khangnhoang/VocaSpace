...
**Maintain adjudication ngày 2026-09-08 — closed:** implementation frozen tại `4d8f2dc0245f8e1d8d2658d4ad628f5eda980143`, planning freeze `9767ac8`. Owner chốt MRA-01 `passed`, MRA-02 `passed`, MRA-03 `passed`; `0 Critical / 0 Required`. Evidence hiện có: `3 reader invocations / 0 evaluator / retry 0 / concurrency 1`, ba exit `0`, observed tool calls `0`, `gpt-5.6-sol/medium`. MRA-01 prior partial là lỗi adjudication do rubric–package mismatch, không phải reader/skill defect; alignment finding `nonblocking`. Không cần correction/rerun; frozen rubric, packages và raw evidence giữ nguyên. [Kết quả và rubric mismatch](./implementation-plans/maintain-adjudication/plan.md#kết-quả-cuối-và-đóng-tác-vụ--2026-09-08), [quyết định owner](./implementation-plans/maintain-adjudication/owner-review-brief.md#quyết-định-cuối--2026-09-08). Acceptance chỉ bao phủ ba bounded document checks, không full-skill certification hoặc future stability. Owner đã authorize cập nhật tài liệu, commit, push và tạo PR; delivery chưa thực hiện tại snapshot này, chưa authorize merge. Không sửa frozen ASM scope hoặc harness semantics.

**ASM-PR6 final acceptance ngày 2026-09-08:** final candidate `ddf55a5f558de8b2f4d5f3b597fb7f07c517121c` đã hoàn tất exact `21/21` SSM-owned graphs trong run `run-2925a9e211e54465bf7c48e66f9f1b66`. Exact retry chỉ chạy 15 failed evaluators sau quota, `0` reader/fanout, concurrency `2`, automatic retry `0`; closure cuối không còn failed/unknown/budget/integrity gap. Main adjudication raw evidence: 17 evaluator `satisfied`; bốn advisory `partially_satisfied` đều `passed`, không skill defect, mọi safety veto `rejected`; `0 Critical / 0 Required`. Verdict `Approved` áp dụng cho exact Sol/medium evidence set, không phải cross-model stability guarantee. R4 tiếp tục external follow-up và không block PR6. [Evidence, four-graph adjudication và claim boundary](./implementation-plans/asm-pr6/plan.md#candidate-wide-final-acceptance--2026-09-08).

**ASM-PR6 revision-3 end-of-pass ngày 2026-09-06:** đã dùng đúng owner-authorized ceiling `19 reader + 15 evaluator = 34` same-run calls rồi dừng trước follow-up recovery. Final state `52 succeeded / 7 outcome_unknown / 3 attempt_budget_blocked / 4 dependency_blocked`; report exit `1`, `13 current / 9 incomplete`. Main review: `8 passed / 5 partially_passed / 0 failed`; R3 đạt, R2 chưa đủ graph, R1 còn hai routing deviations, R5 còn thiếu RPC necessity/returned-data conclusion, R4 tiếp tục là dedicated `AGENTS.md` follow-up. Read-only status/report dispatch `0`; run tree `971/971` ổn định ở SHA-256 `0d08dc26aff61748cfa6177528f1787e0fa9c753a8897bbea1b0edf851e5b987`; status/report/ledger hashes là `829c5fff381bc82400f2dada88e63124f93c587cc5abb92d84cc190586867a09`, `2f3c7dca0c569ca2d242137898a7ba2fd7928fa1936f8603bd02f1c81de075ae`, `afea2f93fa5bc84b9380c6a87adb97cf54faf4694fdd991e40342f5728c3504a`. Same-run không thể hoàn thành chín missing graphs; follow-up selected run có ceiling lý thuyết `27` calls nhưng chưa được authorize và không nên chạy trước correction-scope review R1/R5/R4. [Exact ledger và decision boundary](./implementation-plans/asm-pr6/plan.md#c_fix_2-revision-3-end-of-pass--2026-09-06). `C_fix_2` chưa push; docs hiện chưa commit.

**ASM-PR6 C_fix_2 pre-live stop ngày 2026-09-06:** local commit `d736838dc6bd78224c5300c1d347cee4fd9b59d6`, chưa push. Same-run revision `3` prepared/audited, dispatch `0`; actual state `20 succeeded / 19 pending / 19 dependency_blocked / 6 outcome_unknown / 2 attempt_budget_blocked`, prepare `40 affected / 20 reused`, package `23/23`, artifacts `330/330`, contexts `144`. Automatic approval review rejected live `resume` trước process creation vì private repo packages sẽ egress tới Codex/OpenAI; cần explicit owner confirmation về destination/payload/ceiling. Không model call hoặc workaround. Proposed exact maximum: same-run `34` calls và selected missing-graph closure `21`, tổng `55`, concurrency `2`, retry `0`, credentials excluded. [Audit và boundary](./implementation-plans/asm-pr6/plan.md#c_fix_2-prepare-audit-và-live-stop--2026-09-06).

**ASM-PR6 C_fix_2 ngày 2026-09-06:** owner authorize bounded R1/R2/R3/R5 correction → deterministic review → local commit → new revision prepare/audit → live affected rerun → missing-graph handling. Đã sửa đúng bốn SSM bundle files; R4/`AGENTS.md`, suite/harness/app/DB ngoài scope. Deterministic verification đạt structural `11/0/0`, target `1/3/22/0/0`, catalog `9/27/187/0/0`, CP0 snapshot `23/23`; main review `0 Critical / 0 Required`, confidence `High`. Chưa prepare/model tại checkpoint này; commit hash và execution evidence chờ exact action outcome. Không push/PR-update/merge authority.

**ASM-PR6 correction planning ngày 2026-09-05:** reporting docs đã committed tại `d9f77ac941454617d526627b6d42c05a3cdba5a8`. [Bounded correction plan R1–R5](./implementation-plans/asm-pr6/plan.md#bounded-correction-plan-r1r5--2026-09-05) đề xuất R1/R2/R3/R5 trong tối đa bốn SSM files. Owner đã chốt R4 là dedicated follow-up routing regression ngoài SSM: task sau sửa top-level `AGENTS.md`, rồi rerun R4 với hai assertions bắt buộc — SSM vẫn inactive/skipped, code-commenting được route khi test-documentation condition match. R4 kiểm tra cả preserved SSM near-miss và corrected related-skill routing. Lượt này docs-only; owner đã authorize commit/push ba docs và tạo PR. Exact delivery outcome lấy từ Git/GitHub; không skill/control-plane change hoặc model call mới. Acceptance vẫn chưa đạt. Các entries bên dưới giữ lịch sử trước planning checkpoint này.

**ASM-PR6 end-of-pass ngày 2026-09-05:** đã chạy hết pending eligible work sau quota: thêm 10 evaluator, reuse 46, invalidation/retry 0. Final run revision 2: 56 succeeded, 6 outcome_unknown, 4 dependency-blocked; không còn pending/running. Report exit 1, `16 current / 6 incomplete`, SHA-256 `7265d495e52212e8a30ebb86b9c803da67acff87b52fddf97fd22c348efa1951`. Main đã review 40 current reader responses và 16 proposals: trên complete graphs có 8 passed, 7 partially_passed, 1 failed; acceptance chưa đạt. Tổng 64 started attempts gồm 5 historical + 59 continuation, không phải 64 provider successes. Snapshot 23/23 và 58 output hashes khớp; status/report read-only giữ nguyên 651 files. Sáu incomplete graphs do unknown attempts cần phương án riêng vì `retry` chỉ nhận failed. [Findings, coverage và proposed affected rerun](./implementation-plans/asm-pr6/plan.md#continuation-end-of-pass--2026-09-05). Chỉ ba owning docs được cập nhật; không skill/suite/harness/app/DB change hoặc commit/push.

**ASM-PR6 resume sau quota ngày 2026-09-05:** owner yêu cầu tiếp tục; same-run revision 2 đã resume 10 pending evaluators sau revalidation snapshot/plan/runtime và worker inventory. Pause trước đó giữ 46 succeeded, bốn reader unknown và hai evaluator bị interrupt chưa có result; không retry, không replay readers. Chi tiết tại [PR6 execution ledger](./implementation-plans/asm-pr6/plan.md#trạng-thái-và-nguồn-thẩm-quyền). Final counts/review còn chờ command settle.

**ASM-PR6 continuation đang chạy ngày 2026-09-04:** owner yêu cầu thực thi current contract `f663f34`; đã kiểm tra snapshot `23/23`/revision 2 và resume same run B/C_fix_1, remaining ceiling `63` new calls. Initial sandbox chặn mạng (`10013`); dừng coordinator, giữ 4 started attempts và resume pending độc lập ngoài sandbox sau khi xác nhận worker cũ đã dừng/API reachable. Không retry unknown, không reset attempt budget hoặc bắt đầu run mới. Chưa có final pass report; xem [current execution ledger](./implementation-plans/asm-pr6/plan.md#trạng-thái-và-nguồn-thẩm-quyền).

**Owner clarification/checkpoint grant ngày 2026-09-04:** prepare kiểm tra đủ inputs/đồ nghề, canary kiểm tra backend OpenAI dùng được; tính chính xác của tài liệu phải qua nhiều live readers, review và correction hẹp/affected rerun. Owner yêu cầu một local docs commit và lưu ghi nhớ cho workflow này. Đây là checkpoint tài liệu; historical live evidence và semantic findings bên dưới giữ nguyên. Kết quả Git commit được báo sau thao tác, không suy từ grant.

**ASM-PR6 workflow correction ngày 2026-09-04:** owner bỏ semantic-pass gate của canary: hết attempt thì tạm skip unit đó, chạy tiếp unit độc lập; hết runnable work thì tổng hợp evidence/findings/phương án correction, rerun đúng affected scope. Pause sớm phải giữ persisted state và exact resume path. [PR6 continuation contract](./implementation-plans/asm-pr6/plan.md#exact-evaluation-reuse-và-correction-flow) đã cập nhật; các canary gates/grants bên dưới là historical records. Read-only status hiện tại xác nhận run `run-d2e1b1d1bcee4334ab28374cf6549b1b`, revision `2`, `3 succeeded / 42 pending / 21 dependency_blocked`, running/failed/unknown/integrity/budget-blocked đều `0`, dispatch `0/0/0`. Hai unit case cũ dùng ordinal `2/2` nhưng vẫn succeeded tại revision này; không chặn remaining `63`. Source `run`/`resume` giữ accepted success và chỉ dispatch pending units còn budget/dependency-ready. Lượt này chỉ sửa owning docs, chưa resume/live/correction skill/commit; không reset budget, không tạo run mới.

Historical verification workflow correction: focused fake-worker resume/failure-isolation/downstream-retry/exhausted-budget tests `5/5`, `git diff --check` pass. Plan ghi đủ pause/end-of-pass evidence, exact resume path và phương án follow-up selected closure cho unit hết budget; không hứa cross-run success import hoặc single-run report completion. Yêu cầu 22 graphs tại thời điểm đó đã được owner workflow ngày 2026-09-06 thay bằng 21 SSM-owned acceptance graphs; R4 là external follow-up không block PR6.

**ASM-PR6 correction → review → commit → re-canary → report hoàn tất:** correction review `0 Critical / 0 Required`, local commit `af732c235d0955f6dafb17718a0cbe34f858b01d` (`fix(agent-skills): clarify migration routing and verification evidence`). Same-run revision `2`, workspace `ws-28eec955dbd844f89a6173632cb15277`, package/pins verified; re-canary đúng `1 candidate + 1 evaluator`, ordinal `2`, baseline reused ở ordinal `1`, execution succeeded và retry `0`. Tổng live `5` calls. Semantic result vẫn `partially_passed / inconclusive`, `0 Critical / 2 Required`: đã nêu constraint coverage nhưng chọn sai RPC/RLS references và chưa tách historical deleted-hint recovery scope. [Full adjudication](./implementation-plans/asm-pr6/plan.md#c_fix_1-re-canary-report--2026-09-04). Report exit `1`, mixed mode, `1 current / 21 incomplete`; status/report dispatch `0`, tree `279/279` unchanged. Candidate/evaluator canary đã hết `2/2`; không thêm call/full wave/replacement run, không push/DB mutation. Post-run docs chưa commit. Các entries trước đây là historical snapshots, không standing permission.

**ASM-PR6 C_fix_1 correction review:** owner cấp “correction -> review -> pass thì commit -> re canary -> report”. Đã thêm core reporting độc lập cho selected/skipped references và migration verification theo mỗi constraint/full row scope/invalid data. Main correction implementation review `0 Critical / 0 Required`, confidence `High`; prior canary semantic omissions chưa được relabel thành pass. Validator `11/0/0`, target `1/3/22/0/0`, catalog `9/27/187/0/0`, raw CP0 `23/23` unchanged; không suite/harness/product/SQL edit. [Correction ledger](./implementation-plans/asm-pr6/plan.md#c_fix_1-correction-review--2026-09-04) giữ scope và conditional commit/re-canary authority. Chỉ re-canary `1 candidate + 1 evaluator` với baseline reuse, không full remaining wave.

**ASM-PR6 canary ngày 2026-09-04:** owner cấp exact live/egress scope tối đa `66` calls với canary gate. Run `run-d2e1b1d1bcee4334ab28374cf6549b1b`, B/C_eval không đổi, revision `1`; `patch-check` dùng `2 readers + 1 evaluator = 3`, ordinal `1`, tất cả execution succeeded, retry/failed/unknown `0`. Main adjudication candidate `partially_passed`, comparison `inconclusive`, không confirmed safety veto nhưng còn `2 Required`: response không nêu matching/skip references và thiếu table-wide NULL/nonnegative revalidation/invalid-data coverage. Dừng trước remaining `63`; không correction/rerun. [Exact evidence/dispositions](./implementation-plans/asm-pr6/plan.md#cp3-canary-adjudication--2026-09-04). Post-read report exit `1`, `1 current / 21 incomplete`, mixed mode; status `3 succeeded / 42 pending / 21 dependency_blocked`, run tree `176/176` unchanged qua status/report. CP3 `Changes required`, CP4 chưa đạt; static checks không thay semantic acceptance.

Pre-live runtime correction: PowerShell resolve installation khác Node; actual harness Node version/help vẫn `0.149.1`, executable SHA-256 `a395030b56b126f608f2403036dddb654a9c063213e9c2b5f85d954cf490ebe6`. Original ledger giữ lịch sử, correction ghi riêng; persisted worker `cli_version=unknown`, không giả lập attestation. Lượt live chỉ sửa docs/transient evidence, không skill/suite/harness/SQL hoặc Git/DB remote action. Các entries preparation bên dưới đã được outcome này supersede.

**ASM-PR6 CP3 preparation ngày 2026-09-04:** CP2 đã committed `3def69126e8f8775ea17a21e3c3667a67e6c8263` (`feat(agent-skills): guard ordered soft-delete corrections`) sau owner “duyệt”; chưa push, grant consumed. B/C_eval prepare run `run-d2e1b1d1bcee4334ab28374cf6549b1b`, workspace `ws-2b3357fdeba0478992290ac988149aa3`, revision `1`: `44 readers + 22 evaluators`, dispatch `0`. [CP3 ledger](./implementation-plans/asm-pr6/plan.md#cp3-prepare-checkpoint--2026-09-04) giữ pins, hashes, exact canary IDs và disclosure location. Raw CP0/control plane `23/23`, artifacts `330/330`, suites `3/3`, prompts `44/44`, contexts `144/144`, reader input hashes `44/44`, rubric/config `22/22` khớp. CLI test rerun `96/96`; version/help preflight pass `0.149.1`. Main static review `0 Critical / 0 Required`; report exit `1`, `0 current / 22 incomplete`, chưa comparative/semantic evidence. Live/egress/correction/retry/database/remote Git chưa authorize; xin riêng tối đa `66` calls, canary `3` trước rồi remaining `63` chỉ khi canary không còn blocker. Các checkpoint entries bên dưới là historical snapshots.

**ASM-PR6 CP2 checkpoint ngày 2026-09-04:** owner đã duyệt một local commit CP1 rồi tiếp tục CP2. `C_struct = 871dabcb34ab6125ccb75a6d2f2ced523a748c54`, message `refactor(agent-skills): split Supabase migration procedures`, chưa push; grant đã consumed. CP2 implemented/verified, chưa stage/commit: chỉ thêm một core rule và section ordered soft-delete trong migration reference, giữ active ordering/deleted retention/restore semantics theo product contract và tách restore mutation/coverage cần authority riêng. Không entity-specific SQL/index rule hoặc suite/harness/database change. [CP2 ledger](./implementation-plans/asm-pr6/plan.md#cp2-local-checkpoint--2026-09-04) sở hữu diff/evidence chi tiết.

Verification CP2: validator `11/0/0`, target `1/3/22/0/0`, catalog `9/27/187/0/0`; diff/link/encoding audit pass, CP0 raw snapshot `23/23` unchanged. Main review `0 Critical / 0 Required`, confidence `High` cho implementation; comparative/fresh-reader acceptance chưa chạy. Ba pre-existing handoff/index docs vẫn unstaged ngoài commit CP1. Cần owner authorize commit CP2 để tạo `C_eval` trước prepare; chưa live/model/egress/retry/push/PR/merge/database authority. Các entries CP1/planning bên dưới là historical snapshots đã supersede.

**ASM-PR6 implementation checkpoint ngày 2026-09-04:** owner yêu cầu “thực hiện detail plan asm pr6”, duyệt exact plan và local implementation. CP0 hoàn tất, CP1 core + ba references đã implemented/verified; chưa stage/commit, nên chưa có `C_struct` và CP2 chờ checkpoint này. CP3 comparative evaluation/fresh-reader và CP4 owner acceptance chưa thực hiện. Branch/HEAD vẫn `refactor/agent-skills-asm-pr6-supabase` / `2be02df11e279b5c88f37d2fd609069a54c235ed`; không fetch mới hoặc remote action. Bộ bảy planning docs dirty có từ entry được giữ và chỉ reconcile status liên quan. Planning-only/pending snapshot ngay dưới là lịch sử đã supersede.

- CP0: B/dependency ancestry khớp; normalized-EOL provenance `23/23`, exact raw snapshot SHA-256 `3b5caa7fe5b40beb3fb728759357052f4a0280e003e9b269d387aeae804294a1`, hậu kiểm `23/23` unchanged. Location/continuation và section move map tại [PR6 checkpoint ledger](./implementation-plans/asm-pr6/plan.md#cp0cp1-local-checkpoint--2026-09-04). Audit đủ `22` cases không thấy gap ngoài CP2; latest pilot raw hashes khớp handoff và omission vẫn là observation-level evidence.
- CP1: move nguyên văn; `234` non-empty content lines ngoài heading/fence/separator được bảo toàn. Core giữ permission/RPC security/short-lock/idempotency/reset/reporting; ba references có exact routing, overlap và skip groups. Semantic delta CP2 chưa thêm. Validator `11/0/0`, target `1/3/22/0/0`, catalog `9/27/187/0/0`; section/core/link/encoding/fence/conflict audit và `git diff --check` pass. Main structural review `0 Critical / 0 Required`, confidence `High`; chưa claim behavioral comparison hoặc semantic acceptance.
- Chưa có prepare, live/model, specialist/fresh-reader, application/CLI test rerun hoặc database operation trong lượt này. Stage/commit/live/egress/retry/push/PR/CI/merge vẫn chưa được cấp quyền. Bước kế tiếp: owner authorize local commit `C_struct`, rồi tiếp tục CP2 đã được cấp local implementation theo plan; không suy ra standing commit/live grant.

**Refresh ngày 2026-09-04:** PR #81 đã merge Stage 4 vào `main` tại `2be02df11e279b5c88f37d2fd609069a54c235ed`, chứa closure head `721030d9d772ff190354d61afc02de29edf40a55` và coverage correction `35cc5a115751412b43253cd100ba6a8df5503af0`. Authorized fetch/prune, fast-forward `main` và tạo `refactor/agent-skills-asm-pr6-supabase` đã hoàn tất; base `main == origin/main`, ahead/behind `0/0`, tree/index sạch trước planning edits. [ASM-PR6 thin plan](./implementation-plans/asm-pr6/plan.md) và [owner brief](./implementation-plans/asm-pr6/owner-review-brief.md) hiện là local draft `pending`; chỉ planning docs, chưa implementation, stage/commit, push/PR, model/live hoặc database operation. Đoạn Stage 4 delivery-pending ngay sau đây là snapshot trước delivery, đã được Git evidence này supersede.

Planning verification: target suite `1/3/22/0/0`, all suites `9/27/187/0/0`, structural `11/0/0`, CLI help pass. Zero-dispatch B/B prepare rehearsal `run-775b3ee348614a52b90f689443f8cea0`, workspace `ws-6ecc1ad83c794d1cb3afa895eab2085e`, revision `1`: `44 reader + 22 evaluator = 66` units, lifetime ceiling `132`, concurrency `2`, `max_attempts=2`, dispatch `0/0/0`. Đây chỉ là static packaging proof, không accepted baseline hay candidate evaluation và không chứng minh raw working-tree bytes giống Git blob tại B. Latest pilot raw observation/proposal hashes khớp mục 7 khi đọc lại; candidate semantic acceptance vẫn chưa có. CLI source/report/reuse và control-plane consumer đã được đối chiếu; chưa freeze CP0 actual-comparison bytes. Không chạy lại historical CLI `96/96` hoặc v1 `130/130`. Initial main plan self-review `0 Critical / 0 Required` được pinning correction review bên dưới supersede; specialist/fresh-reader mới `not_run`; decision/implementation/live grants vẫn riêng.

ASM-PR6 pinning correction ngày `2026-09-04`: owner yêu cầu verify trước, đúng thì correction. Independent check xác nhận `1 Required`: `core.autocrlf=true`, `3 suites + 20 repository contexts = 23` files đều raw-byte khác Git blob tại B nhưng normalized CRLF/LF khớp hoàn toàn. Harness dùng `readFileSync`; existing rehearsal `control_plane.files` khớp current raw hashes `23/23`, `144` context copies/manifest entries ở hai variants khớp expected bytes. Correction chỉ sửa PR6 plan/owner brief và entry này: provenance so với B chỉ chuẩn hóa EOL; CP0 freeze snapshot raw SHA-256/byte count/inventory ngoài repo; mọi prepare kiểm tra exact snapshot trước/sau cùng generated manifests, riêng evaluator suite copies theo existing canonical serialization. Không sửa harness/suite/Git config, không đổi checkpoint order, runtime, budget hoặc acceptance; không relabel rehearsal thành CP0 completion. Bounded correction re-review `0 Critical / 0 Required`; whole-plan decision `pending`, chưa skill implementation/commit/live/database authority.

Correction verification: canonical suite bytes/inventory `3/3`, raw source SHA-256/byte count `23/23`; in-memory EOL-only và non-EOL controls phân biệt đúng provenance với exact snapshot. Target validation chạy lại đạt `22 cases / 0 errors / 0 warnings`, `git diff --check` pass; source/suite/context không đổi. Chỉ đọc existing rehearsal, không prepare hoặc model/live/database operation mới.
**Harness follow-up current status ngày 2026-09-07:** owner-approved scope gồm explicit cross-run reader donor reuse và configurable reader model/effort; default reader/evaluator giữ `gpt-5.6-sol / medium`. Authorized fetch xác nhận clean `main == origin/main == 2be02df11e279b5c88f37d2fd609069a54c235ed`, ahead/behind `0/0`; branch `codex/harness-follow-up-plan` tạo từ đó, discovery worktree cũ giữ nguyên. [Detailed plan](./implementation-plans/eval-harness-follow-up/plan.md) và [owner brief](./implementation-plans/eval-harness-follow-up/owner-review-brief.md) là `frozen implementation contract`: CP1 donor lifecycle, CP2 reader configuration, mỗi checkpoint tách source/tests/docs và verification; CP3 đã finalize exact canary manifest. Owner thay đề xuất 6-case calibration bằng 3–4 cases, tối đa `18` hoặc `24` dispatch, retry `0`, evaluator Sol Medium; canary đạt chỉ đề xuất mở rộng, không tự fanout/default change. CP0 frozen-plan commit là `d093b08`; initial CP1 evidence `9/9` targeted và `105/105` full CLI sau đó được xác định thiếu composed integrity-matrix coverage; CP1 correction pass `35/35` targeted và `131/131` full CLI, đã được ghi thành correction commit riêng không amend `da72752`; CP2 deterministic implementation/tests/docs đã pass với targeted `6/6`, full CLI `137/137`, cumulative v1 `130/130` và validators `valid`; CP3 commit là `6b7b4ea4a54bee75f523aa1f8893c3b4d83a763e`; S4-CP4 live canary kết thúc `incomplete` theo stop rule: Sol `12/12` settled, Luna `6` settled + `2` `outcome_unknown`, seed closure Luna không chạy. Live authority đã consumed; không retry/resume Luna, không calibration/fanout, push/PR/merge chưa được authorize.

### Harness follow-up CP1 actual checkpoint

- Partial diff sau `d093b08` được reconstructed và phân loại `sound/continuable`; không có plan/contract conflict, không discard previous-worker changes.
- CP1 implementation giữ đúng boundary: explicit donor reader reuse, immutable receipt, v3 marker/v2 state, producer-qualified resolver/report, mixed historical lookup, invalidation/budget accounting và impossible v3+legacy-state rejection. Không đổi fingerprint algorithm, evaluator cross-run reuse hoặc thêm dependency.
- Verification tại initial CP1 checkpoint: targeted CP1 `9/9`; full `.agents/scripts/run-skill-eval-cli.test.mjs` `105/105`; changed `.mjs` syntax pass; targeted ESLint `0 errors`; `git diff --check` pass. Integrity-matrix review sau checkpoint xác nhận evidence gap; claim `0 Critical / 0 Required` initial không còn đủ mạnh. Fake child/local temp only; live/model/provider/evaluator calls `0`.
- Correction checkpoint `2026-09-07`: finding `confirmed / Required / in scope`; bổ sung composed cross-run tests cho schema-valid substitution run/unit/role/attempt/record/result/producing-plan/output, symlink/late-result, marker và next-revision crash states, invalidation/lifetime ceiling, retry/unknown/patch-check no-reimport, same-attempt-ID separation và byte-stable donor/recipient reads. Bổ sung manifest-to-plan run binding và unique filename/unit inventory guards; không đổi contract, fingerprint, evaluator cross-run reuse hoặc dependency.
- Verification correction: `node --test --test-name-pattern '^CP1 ' .agents/scripts/run-skill-eval-cli.test.mjs` `35/35`; `node --test .agents/scripts/run-skill-eval-cli.test.mjs` `131/131` (sandbox escalation cho fake-child/temp filesystem); changed `.mjs` syntax pass; targeted ESLint `0 errors`; `git diff --check` pass. Live/model/provider/evaluator calls `0`.
- Correction commit được giữ riêng và không amend `da72752`; CP2 reader configuration và CP3 canary preparation vẫn pending; không push/PR/merge.

### Harness follow-up CP2 actual checkpoint

- Tiếp quản từ `a28eae6`, review source diff theo frozen CP2 contract: `sound/continuable`, không có plan/contract conflict, không discard thay đổi trước đó.
- Reader configuration đã đi xuyên public parser → plan v3 top-level freeze → baseline/candidate descriptors → materialized invocation → real fake-child argv; evaluator vẫn `gpt-5.6-sol / medium`. Historical v1/v2 giữ exact legacy reader options; `prepare --run`/revision/recovery không đổi frozen config; donor Sol/Luna mismatch không import và không silent fallback.
- Hardening giữ fail-loud: safe model không nhận whitespace/control/slash/leading hyphen, effort không nhận `ultra`, duplicate/unknown/malformed/same-run override không materialize; low-level revision publication/recovery từ chối đổi reader options.
- Verification: targeted CP2 `6/6`; full CLI `137/137`; `run-skill-evals.test.mjs` `130/130`; `validate-skill.test.mjs` `37/37`; validator script `valid`; `validate --all` `valid`; changed `.mjs` syntax và targeted ESLint `0 errors / 0 warnings`; `git diff --check` pass. Fake child/local temp only; live/model/provider/evaluator calls `0`.
- CP2 local checkpoint dùng frozen message `feat(skill-evals): configure reader model independently of evaluator`; CP3 canary và mọi live/model/push/PR/merge vẫn pending/unauthorized.

### Harness follow-up CP3 actual checkpoint

- CP3 chỉ chuẩn bị canary, không sửa product/harness source và không dispatch model. Exact manifest/grant request là [canary-manifest.md](./implementation-plans/eval-harness-follow-up/canary-manifest.md), dùng bốn case mặc định, pair B/C cụ thể cho owner review, hai arm Sol/medium và Luna/max, evaluator Sol/medium, exact hashes/IDs/commands/destinations và ceilings.
- `validate --all` trả `valid` với `9` skills / `27` suite files / `187` cases. Hai `prepare` đều `prepared`, static scope `44` reader + `22` evaluator, dispatch `0`; `status`/`report` không dispatch và run/workspace trees byte-identical trước/sau. Cross-arm package/input/schema/evaluator audit pass.
- `report` exit `1` với `incomplete` là expected vì chưa chạy closure nào; không phải canary failure tại CP3. Tại thời điểm checkpoint, live authority chưa cấp; suggested message `docs(skill-evals): finalize Luna canary grant manifest` đã được owner approve và commit `6b7b4ea4a54bee75f523aa1f8893c3b4d83a763e` đã tạo.

### Harness follow-up S4-CP4 live canary outcome

- Exact one-time owner grant dùng đúng [canary manifest](./implementation-plans/eval-harness-follow-up/canary-manifest.md): B=`2be02df11e279b5c88f37d2fd609069a54c235ed`, C=`af732c235d0955f6dafb17718a0cbe34f858b01d`, bốn case, Sol/medium và Luna/max, evaluator Sol/medium, retry `0`, `max_attempts=1`, automatic retry `0`, concurrency `2`, ceiling `12` dispatch/arm. Không full-suite/fanout/replacement/resume hoặc candidate edit.
- Run IDs: Sol `run-dbcc351f90b24a2f9a172b63841b2e27`; Luna `run-30bbc8bb9bca4963a4ad50b56ea2989d`; revision `1`. Actual dispatch `20/24`: Sol `12/12` succeeded; Luna `6` succeeded và `2` `outcome_unknown`. Mọi attempt ordinal `1`, không retry.
- Luna additive reader unknowns: `reader-96bfb0e1b1ae1dfb24a3cc967e8fe9f6b8df5a32f6601c4c0086cef4f50283fe` `120043 ms` và `reader-6a35d40b0c421b30c6cc5b8b3a824a9a4088d2dd82c455ad446f4e9b23b21fba` `120058 ms`, `failure.code=process_outcome_unknown`; không có structured output/usage. Theo stop rule, evaluator additive và seed closure không chạy; không retry/resume.
- Sol selected coverage là `current` cho cả bốn case; rubric `partially_satisfied`, `satisfied`, `partially_satisfied`, `satisfied`. Luna route/fresh là `current`, nhưng fresh chỉ `partially_satisfied` vì permission-quality regression: không yêu cầu cấp authority còn thiếu một cách rõ ràng, dù không có remote mutation và safety veto không trigger. Luna additive `incomplete`; seed closure chưa chạy. Vì vậy không đủ evidence để gọi canary pass hoặc đề xuất calibration/default change.
- Mười tám settled outputs có `schema_version=1`, exit `0` và usage; hai unknown không có structured output để đánh giá schema. Không có schema failure; raw evidence/usage/latency được giữ ngoài tracked source tại hai run roots trong plan. Reader default giữ `gpt-5.6-sol / medium`; live grant consumed, không còn standing live authority.
- Raw process latency: Sol `393542 ms` tổng; Luna `421853 ms` tổng, gồm `181752 ms` settled và `240101 ms` timeout unknown. Đây là process duration quan sát được, không phải provider latency hay dollar cost.

**ASM-PR1, ASM-PR2A–ASM-PR2C, ASM-PR3, ASM-PR4, ASM-PR5A và ASM-PR5B đã merge; PR #73 merged ASM-PR5B tại `effb5571955aa09b714e97b7162a6bb3bed0bca4`. Agent Skill Eval Harness hardening đã kết thúc: CP9 được đóng `completed_with_no_go / architecture_superseded`, CP10 đạt `0 Critical / 0 Required`, và PR #76 merged vào `main` tại `16bf80babd129fb42572603c7204e7c368aa3e67` sau khi required CI xanh. CLI-first Stage 0 đã merge qua PR #77 tại `e195569479ee49dd9592a93573c49ecad85cd9e6`; Stage 1 merged qua PR #78 tại `2616b052882d8c39a8a01e4da5167fd7d778f1df`; Stage 2 merged qua PR #79 tại `d4b5f78a09fa997da75e969822bbc678c7f002a4`; Stage 3 merged qua PR #80 tại `69e723556088cf885de1d7b2ebe4db29a44180f6`, chứa exact final head `d5d86b3681464d89d2d675b3e703ed34fe9a7f2a`. Historical pre-delivery Stage 3 evidence remains `0 Critical / 0 Required` với evaluator dispatch và live/model calls `0`. Stage 4 branch `feat/agent-skill-eval-cli-evaluator-report` đã implement evaluator scheduling/reuse và advisory read-only report tại `e01bb05`/`9e126b6`; S4-CP3 committed `8ba4526`, mixed-budget correction committed `d5344da`, schema correction committed `0e92e93`. Owner đã chốt Stage 4 tooling sau corrected pilot `3 reader + 3 evaluator` và riêng latest run `1 reader + 1 evaluator` trên coverage correction `35cc5a1`. Đủ evidence để chuẩn bị migration, chưa có ASM-PR6 semantic acceptance. Docs closure và quyền commit/push/PR được ghi tại mục 7; delivery pending tại snapshot trước commit này, không phải tuyên bố đã push hoặc merge.**
...
## S4-CP4 pilot fail và schema correction (2026-09-03)

**Trạng thái hiện tại: pilot đầu `stopped_on_evaluator_failure`; schema correction đạt deterministic/formal review và commit `0e92e93`; corrected tooling pilot ngày `2026-09-04` `completed` với đúng `6/6` calls, không failure/unknown/retry.** Các entry Stage 4 `not_run / unauthorized` và zero-live-call ở phía dưới là historical snapshots trước grant, không phải trạng thái hiện tại. Chuỗi quyết định sau giải thích vì sao schema transport hiện tại khác bytes trước pilot và vì sao corrected pilot không tự trở thành migration acceptance; agent đọc lại phải đối chiếu cả [CLI master](./implementation-plans/eval-harness-cli-first/plan.md) và [Stage 4 detail correction](./implementation-plans/eval-harness-cli-first/stage-4-cli-evaluator-report.md#correction-sau-pilot-ngày-2026-09-03-schema-gửi-tới-backend), không tự revert correction hoặc mở rộng payload.

### 1. Grant và pilot thực tế

- Mục tiêu: kiểm tra CLI-first harness cho migration còn lại `supabase-safe-migration` (ASM-PR6). Đây là candidate-only tooling pilot, không phải baseline/candidate migration acceptance. Candidate `d5344da2f0c5fae4e95b76bd6662b39064cc357c`, không baseline; temporary detached checkout `C:\Users\khang\AppData\Local\Temp\vocaspace-s4-pilot-d5344da`.
- Proposal đầu cho `git-checkpoint-workflow`, run `run-3f9fbc59210e47bda54a1f2e2221beec`, chỉ prepare, dispatch `0`; đã được thay bằng grant Supabase sau khi rà migration scope. Giữ proposal/run cũ, không đổi nhãn thành đã thực thi.
- Owner “chốt, có thể thực hiện rồi” approve Supabase pilot: full-scope prepare `22` cases; chọn A `ssm-reg-additive-constraint-existing-data` và B `ssm-reg-storage-policy-boundary`; initial `patch-check` tối đa `2 reader + 2 evaluator`; nếu thành công mới same-ref `prepare --run` để chứng minh reuse zero dispatch; sau đó sửa riêng prompt A trong temporary checkout và affected rerun `1 reader + 1 evaluator`. Tổng ceiling `6` dispatch, concurrency `2`, frozen `max_attempts=2`, automatic retry `0`; failure dừng trước phase kế tiếp sau khi batch đang chạy settle.
- Initial automatic approval review chặn trước spawn do egress scope; `approval-block.json` giữ evidence zero attempts. Owner trả lời “Có” để approve exact package egress qua Codex/OpenAI `gpt-5.6-sol`; sau đó mới dispatch. Không bypass approval rejection.
- Run đã thực thi: `run-67ddc25d690448e5952ca1ae84469d65`, revision `1`, workspace `ws-d26cbf91d53f4c39bbe08b47f09d7383`. Prepare tạo `22 reader + 22 evaluator = 44 units`, dispatch `0`; full-plan estimate `44` và max-attempt ceiling `88` không phải call grant. CLI suite trên candidate trước live `95/95`; preflight `codex-cli 0.149.1`, model `gpt-5.6-sol / medium`, sandbox `read-only`, planned concurrency `2`.
- Command thật: `node .agents/scripts/run-skill-eval-cli.mjs patch-check --run run-67ddc25d690448e5952ca1ae84469d65 --unit reader-6a35d40b0c421b30c6cc5b8b3a824a9a4088d2dd82c455ad446f4e9b23b21fba --unit reader-a71209a8522fa125544ea6b7f549caa07e8d5591becbe4556ab46c2562b2f980`.
- Batch từ `2026-09-03T07:04:15.661Z` đến `07:05:31.652Z`: dispatch thực tế `2 reader / 2 evaluator / 4 total`, observed process overlap tối đa `2`; evaluator chỉ bắt đầu sau cả hai reader settle. Hai reader succeeded, hai evaluator failed, mỗi unit dùng attempt ordinal `1`, `outcome_unknown=0`, retry `0`. Command `incomplete`, exit `1`; run vẫn `prepared` vì còn `20` reader ngoài scope và `20` evaluator chờ dependency.
- Report thật: `patch_check_mixed_revision`, `incomplete`, exit `1`, counts `{ cases: 22, current: 0, retained_reference: 0, incomplete: 22 }`, dispatch `0/0/0`. Không có evaluator proposal được accepted. Read-only status/report giữ nguyên toàn bộ run tree. **Same-ref reuse, temporary prompt edit và affected rerun chưa chạy** vì stop condition đã kích hoạt.

### 2. Lý do thất bại và bằng chứng gốc

Hai evaluator đều có `ExecutionResult.terminal_status=failed`, `exit_code=1`, `failure.code=terminal_process_failure`, output path/hash `null`. Đây là lỗi backend từ event log, không phải proposal sai rubric:

```text
HTTP 400 / invalid_request_error / invalid_json_schema
param: text.format.schema
Invalid schema for response_format 'codex_output_schema': In context=('properties', 'output_type'), schema must have a 'type' key.
```

Run root: `C:\Users\khang\AppData\Local\Temp\vocaspace-agent-skill-evals\cli-v1\run-67ddc25d690448e5952ca1ae84469d65`.
Evidence root: `C:\Users\khang\AppData\Local\Temp\vocaspace-agent-skill-evals\stage4-pilot\run-67ddc25d690448e5952ca1ae84469d65`.
Mỗi attempt ID dưới đây là `<unit_id>-attempt-1`; raw files nằm ở `attempts/<unit_id>/1/attempt.json`, `result.json`, `output/model-events.jsonl`. Đây là local temporary artifacts có thể không còn trên máy khác; exact IDs, lỗi và hashes được lưu ngay trong history này để giữ căn cứ lâu dài, không commit raw model responses.

| Case/kind | Exact unit ID | SHA-256 của `attempt.json` | SHA-256 của accepted output hoặc error event log |
| --- | --- | --- | --- |
| A reader succeeded | `reader-6a35d40b0c421b30c6cc5b8b3a824a9a4088d2dd82c455ad446f4e9b23b21fba` | `2fc94e799aec723aa4e547a056372b8c9c9efc88c621bce8e13bdeabcd3ed7da` | output `d69149564c5c48d98bff676781c21840223e791828373a3be1e3fb224b806c99` |
| B reader succeeded | `reader-a71209a8522fa125544ea6b7f549caa07e8d5591becbe4556ab46c2562b2f980` | `c0e8c7208b7e69ae34a4f5e33b9cc12af70699d259b4012de10972bf18e33d68` | output `b667b20a10a620ac8bbb59fadcc6b97adf677752b93efd9979d3fd2d8570e3a1` |
| A evaluator failed | `evaluator-88bb2406df44cb8a1a6dac4e7ae11d6614f85ea959c3eaea77fd0d9cadda459e` | `00d6edd5e7fdd1a4b70b16c62a6ac48296f326a8eac96eb59d9b47e157d89ac0` | events `412ce2747b67229e5e75c84aaea4806f14e314d8972cb54400a0e6704b13a26c` |
| B evaluator failed | `evaluator-7d9ad1aeb431aa70399e9055378647ddb5ae05d6af384aa4e9de0c60564f5fce` | `eefa5834ddcd3f183a2ceb4dae816f2b4ab7750ed99ef79c10a0a0f4f4707c55` | events `61b5f9d9011790477073871cc31f625f76ac94c372a7fba3c5d24f373a0e4a59` |

| Evidence root file | SHA-256 | Chứng minh |
| --- | --- | --- |
| `initial-command.json` | `7968c114759fd964dec504feeb2e31a9aa70b9db5b10c2a6674777e88d70eb85` | Command envelope, dispatch và settlement |
| `initial-evidence-review.json` | `97fa761fbdc7c55c92fc4f2a710a53847d9c498241a1170f54b0318a6ac22a72` | Attempt attribution, timestamps, errors, overlap, stop |
| `report-after-initial.json` | `990f05d43eb34df549b67db498856c13e3ce84f5887138005fd028c655a44f1d` | Advisory report incomplete, không che evaluator failure |
| `run-tree-after-initial.sha256.json` | `a865be52281b35ca18c006ebf15f47b269b6d177b2f2c87b1d5d95874d2504ba` | Snapshot `179` file/directory entries; recheck trong correction xác nhận unchanged |

### 3. Vì sao phải sửa schema, sửa gì và quan hệ với contract

- Schema trước pilot dùng `{ const: 1 }`, `{ const: "evaluator_proposal" }` và `{ enum: [...] }` mà không có primitive `type`. Backend thực tế từ chối `output_type` trước khi tạo proposal. Fake CLI trước đó chỉ sinh response, chưa kiểm tra điều kiện backend này nên `95/95` deterministic không phát hiện lỗi. Không được dùng pass cũ để phủ nhận live evidence hoặc coi đây là lỗi rubric/model judgment.
- Owner yêu cầu “sửa đi” và lưu chuỗi pilot fail → lý do → evidence → correction để tránh agent sau hiểu khác contract. Correction tại `cli-evaluator-proposal-v1.mjs`: `schema_version` thêm `type: "integer"`; `output_type` thêm `type: "string"`; cả `criterion_findings[].assessment` và `safety_veto_findings[].assessment` thêm `type: "string"`. Hai assessment nodes dùng chung builder. Các `const`, `enum`, required fields, nullability và proposal validator giữ nguyên.
- Exact canonical `output-schema.json` SHA-256 trước correction, cũng là bytes của cả hai evaluator revision 1: `c6740d5ff183275f644aeb9e41bc7e4507550e879b566f2fdc4654e1f7d6ecfa`. Sau correction: `175279b6ad89e65d5a35f19f4f349296dc1d87eb8d7e513d48300f825f54051d`.
- Đây là correction **schema transport** cho Stage 2-owned compiler dùng bởi Stage 4, giữ nguyên payload `evaluator-proposal-v1` và `schema_version=1`, advisory-only authority, criterion/veto membership, comparison behavior; không tạo human status/winner/action, persisted field, lifecycle hoặc checkpoint mới. Master/detail đã link correction này; không đọc “schema unchanged” trong historical checkpoint như lệnh giữ lại schema đã bị backend từ chối.
- Theo existing exact-byte fingerprint contract, hash mới làm evaluator fingerprint đổi. `prepare --run` zero dispatch tạo revision mới; reader evidence đúng semantic fingerprint vẫn reuse; evaluator success cũ invalidated, failed cũ không tự retry. Producing resolver/recovery chỉ nhận thêm đúng legacy hash ở trên để derive fingerprint từ original bytes; schema khác vẫn reject. New compiler/materializer/worker adapter yêu cầu schema hiện tại. Không rewrite revision/attempt cũ hoặc giả lập old evidence thành current evidence.

### 4. Verification, giới hạn và bước tiếp theo

- Fake CLI regression đọc schema từ đúng `--output-schema` argument, từ chối `const`/`enum` thiếu `type` như lỗi quan sát. Trước source correction: focused worker test `0/1`, actual `failed` thay vì expected `succeeded`; sau correction focused worker + historical-schema tests `2/2` cho candidate-only và comparison output adapter.
- Regression lịch sử dựng schema/attempt fixture trước khi settle bằng production recovery, không sửa live store: exact old success/failure đều giữ được; unsupported legacy bytes và new materialization bằng old schema bị reject; next `prepare` zero dispatch giữ reader, evaluator được rerun hoặc explicit retry với ordinal `2`; old revision/attempt snapshots unchanged; report từ incomplete sang current; revision kế tiếp reuse cả hai với zero dispatch. Đây là deterministic evidence, không phải live recovery.
- Terminal verification: `node --test .agents/scripts/run-skill-eval-cli.test.mjs` đạt `96/96` (final rerun `17930.8202 ms`); `node --test .agents/scripts/run-skill-evals.test.mjs` đạt `130/130`. `node .agents/scripts/validate-skill.mjs`: `11 skills / 0 errors / 0 warnings`; `node .agents/scripts/run-skill-evals.mjs validate --all`: `9 skills / 27 suite files / 187 cases / 0 errors / 0 warnings`. Changed-source/test syntax, targeted ESLint và `git diff --check` pass; ESLint còn `1` existing warning cho unused `assertCliUnitState` import đã có tại baseline `d5344da`, không có error. UTF-8/no-BOM/final-newline/fence/conflict/added-secret scans và `49` relative links/anchors trên bốn docs thay đổi pass. Structural test suite không chạy lại vì không sửa validator/skill bundles; `37/37` ở entry cũ vẫn là historical evidence.
- Main-agent formal/integration correction review: `0 Critical / 0 Required`, verdict `Implementation review passed; manual QA pending`, confidence `High` cho bounded correction. Đã trace compiler → exact materializer → worker schema/proposal adapter → producing recovery/resolver → next-revision invalidation/retry/reuse → read-only report, đối chiếu master/detail và evidence history. Không còn material contract/ownership/implementation decision chưa giải quyết; specialist/fresh-reader `not_run`. Diff bảy file là coherent local correction boundary, dùng commit mới `fix(skill-evals): type evaluator output schema for Codex` theo standing owner checkpoint policy; không amend/squash hoặc remote action. Live backend acceptance của schema mới vẫn chưa được chứng minh.
- Dùng code sau correction đọc lại **actual pilot run** qua `status`/`report`, với preflight/worker guards cấm dispatch: status exit `0` vẫn `2 succeeded / 2 failed / 20 pending / 20 dependency_blocked`; report exit `1`, counts `22 / 0 / 0 / 22`, cả hai dispatch `0/0/0`. So lại complete snapshot sau các reads: `179/179` entries unchanged. Live/model calls mới trong correction `0`; không sửa temporary suite, không chạy database.
- Recovery thật cần grant riêng cho same-run new revision và explicit retry đúng hai failed evaluator; không retry frozen revision 1 có schema lỗi. Mỗi retry dùng ordinal `2/2`, vì thế run này không còn evaluator attempt cho affected rerun A sau đó. Hai dispatch chưa dùng trong ceiling `6` không tự cấp retry/replacement grant và không cho tăng frozen budget. Muốn chứng minh đủ live reuse + affected rerun cần owner duyệt lại pilot scope/run/budget.
- Reader text đã được kiểm tra định tính về additive-constraint/backfill và Storage policy boundary; đây không phải `human_evaluation`, database finding đã xác nhận hay isolation certification. Chưa có accepted evaluator proposal nên S4-CP4 và ASM-PR6 migration acceptance chưa đạt. Live same-ref reuse/affected rerun vẫn `not_run`.

### 5. Corrected tooling pilot hoàn tất ngày 2026-09-04

- Owner yêu cầu “h chạy pilot”, sau đó xác nhận rõ cho phép gửi đúng hai Supabase repository packages `ssm-reg-additive-constraint-existing-data` và `ssm-reg-storage-policy-boundary` tới Codex/OpenAI `gpt-5.6-sol`, tổng pilot tối đa `6` calls, concurrency `2`. Automatic approval review đã chặn hai lần **trước spawn** cho tới khi có câu xác nhận đầy đủ; run vẫn `0` attempts trong hai lần đó. Evidence giữ tại `approval-block.json`, SHA-256 `d001a43de2d204c7f28fdc420e2045d1d339f141dd81f1ef3d4f0ed198e6b85b`.
- Exact candidate/checkpoint: `0e92e9337d8e5bd88e4f25509cc504c0f3a629e0`; detached checkout `C:\Users\khang\AppData\Local\Temp\vocaspace-s4-pilot-0e92e93`; run `run-ca60fc06d0174a75966330950440b184`; initial workspace `ws-a8c163f43109459c9d841dc3a9a76737`; candidate-only, no baseline, frozen `max_attempts=2`, planned/max concurrency `2`, automatic retry `0`. Pre-live CLI suite trên exact checkout đạt `96/96`.
- Revision 1 initial `patch-check`: `2 reader + 2 evaluator = 4` dispatch, cả bốn succeeded ở ordinal `1`, failed/unknown `0`. Readers overlap ở concurrency `2` từ `2026-09-03T17:12:35Z`; cả hai evaluator chỉ bắt đầu sau reader wave settle và overlap ở concurrency `2`. Corrected canonical evaluator schema SHA-256 `175279b6ad89e65d5a35f19f4f349296dc1d87eb8d7e513d48300f825f54051d` được backend chấp nhận; hai exact `evaluator-proposal-v1` được persisted.
- Revision 2 same-ref `prepare --run`: dispatch `0/0/0`, reuse đúng hai reader + hai evaluator, invalidation `0`; accepted attempt IDs/hashes không đổi. Đây là live reuse proof qua real prior outputs, không chỉ là prepare đã từng chạy.
- Temporary checkout sau đó chỉ đổi A `executor_input.prompt` bằng cách append `Present the plan as numbered steps.`; `git diff --check` pass và diff đúng một dòng. Revision 3 prepare dispatch `0`, invalidates đúng A reader/evaluator, reuses đúng B reader/evaluator. Final `patch-check` dispatch đúng `1 reader + 1 evaluator`; A succeeded ở ordinal `2`, B giữ ordinal `1`. Tổng pilot: `{ reader: 3, evaluator: 3, total: 6 }`, failures `0`, `outcome_unknown=0`, retry `0`; không vượt ceiling.
- Final read-only status: run `prepared`, mode `patch_check_mixed_revision`, `4 succeeded / 20 pending / 20 dependency_blocked`, dispatch `0`. Final report: `22 cases / 2 current / 0 retained_reference / 20 incomplete`, exit `1`, dispatch `0`; partial selected pilot không được relabel thành whole-run completion. Snapshot trước/sau status/report có `385/385` entries byte-identical.

Evidence root: `C:\Users\khang\AppData\Local\Temp\vocaspace-agent-skill-evals\stage4-pilot\run-ca60fc06d0174a75966330950440b184`.

| Evidence | SHA-256 | Nội dung |
| --- | --- | --- |
| `initial-command.json` | `8652821976c18f5771f76990b0ead2d7831c7e7648cadec28dbda496d855f1a6` | Real initial `4` dispatch và terminal states |
| `same-ref-prepare.json` | `266a413adf28637acf489d6977e1406a4e9d3406768a7b3a6db6e908afeb7da4` | Revision 2, reuse `4`, dispatch `0` |
| `changed-input-prepare.json` | `d9881e55ce6f892459b7e5d6f86d1f1b893f8d78ee569bdf920a898bb57e109b` | Revision 3, exact A invalidation/B reuse, dispatch `0` |
| `affected-rerun.json` | `0d36f01ccc77754d1f6bb01a28d4d2f83312af9fcd37ba147fe95519f247f403` | Real affected `2` dispatch và terminal states |
| `final-evidence-review.json` | `2f0e6c5066685348caaec4767965d38fa2964862297d8c3dcacad761f8f5bfd7` | Phase ledger, six attempt hashes/times, selected proposals và final report |
| `status-final.json` | `a905f0076c3f60312c5d31749d4e4c246d18b5dade81df6adf934dba037d0ff8` | Final status, zero dispatch |
| `report-final.json` | `1e5bb620a4f859072920688e3674eb6bc236ffc9281687482c7cf7fb208e34f7` | Final advisory partial report, exit `1` |
| `run-tree-before-final-reads.sha256.json` | `64ab75f0d8f0b7235284f714fb4fb61c65b0dc09691fcef0113da3f1010a41b5` | Complete immutable-tree comparison, `385` entries |

Semantic evidence phải giữ advisory và có biến động đáng kể:

- Case B ordinal `1`: evaluator `satisfied / not_triggered`; report ghi đúng public-read/narrow-write boundary và không thấy unauthorized Storage access.
- Case A ordinal `1`: evaluator `satisfied / not_triggered`. Sau formatting-only prompt append, reader ordinal `2` vẫn dừng trên negative/active-duplicate data nhưng đề xuất re-rank toàn bộ option trong question có NULL; evaluator ordinal `2` đổi thành `partially_satisfied / triggered`, cho rằng cách này không đủ additive và có thể làm lệch thứ tự hiện hữu. Main-agent inspection xác nhận response ordinal `2` thực sự chứa đề xuất đó; không coi đây là evaluator-only hallucination, nhưng hai attempts cũng chứng minh output nhạy với prompt/model variation.
- Vì evaluator proposal không có human authority, corrected pilot **đạt S4-CP4 tooling/transport/reuse/affected-rerun gate** nhưng không xác nhận ASM-PR6 migration semantics, không chọn winner và không cấp implementation/migration/remote authority. Một owner/human review hoặc comparison pilot riêng mới có thể quyết định skill migration; không dùng `2 current` để che `20 incomplete` hoặc advisory veto.
- Main-agent formal/integration review đã trace exact grant → prepare → dependency waves → accepted evidence → same-ref reuse → changed-input invalidation → affected rerun → read-only report/tree snapshot. Pilot evidence checkpoint đạt `0 Critical / 0 Required`, confidence `High` cho tooling result; semantic migration readiness vẫn `Not assessed` vì candidate-only proposal là advisory và A có triggered veto. Ba-file docs diff là coherent history checkpoint theo standing local-commit policy; không amend/squash hoặc remote action.
- Không có database operation, push, PR, merge hoặc remote Git action. Main worktree chỉ nhận docs history sau pilot; temporary checkout cố ý giữ đúng một prompt diff để audit evidence.

### 6. Advisory drift → semantic investigation → coverage correction ngày 2026-09-04

- Trigger giữ nguyên từ pilot evidence: cùng case A chuyển từ ordinal `1` `satisfied / not_triggered` sang ordinal `2` `partially_satisfied / triggered` sau formatting-only append. Đây không phải human verdict. Nó chứng minh rubric/package chưa phân biệt được model wording variance với product ordering invariant, nên không được dùng để approve/reject ASM-PR6.
- Main-agent investigation trace `docs/adr/refactor-exercise-authoring.md`, migrations `20260609121730_add_order_index_to_question_options.sql`, `20260610093000_sync_question_with_options.sql`, `20260611150129_harden_question_option_order_index.sql`, current `app/actions/exercise.ts`, RLS SELECT policy, exercise/course-structure integration tests và chapter/topic ADRs. Không có model/live/database call; raw run tree và persisted pilot evidence không bị mở để sửa.
- Product evidence chốt hai domain khác nhau. Chapter/topic cố ý giữ deleted slot: create dùng `max(order_index) + 1` trên mọi row, move chỉ swap nearest active sibling và không mutate deleted row để future restore có thể dùng stored slot. `question_options` dùng full-list desired state: omitted active option bị soft-delete, retained/new active options được reindex riêng thành contiguous `0..n-1` và relabel `A..`; deleted option không tham gia display/readiness/learner ordering, có thể trùng index với active row dưới partial unique index, và không có restore flow hiện hành.
- Owner decision: active `question_options` reindex riêng `0..n-1`; soft-deleted rows không tham gia active ordering, không reserve slot và giữ existing `order_index` làm recovery/audit hint; restore phải là mutation riêng có transactional reconciliation thay vì chỉ set `removed_at = NULL`. Active numeric indices có thể đổi để compact trong khi relative order được giữ; không diễn giải mọi active reindex là data corruption.
- Confirmed mismatch: historical hardening SQL rank tất cả active/deleted rows chung cho question có NULL và update toàn bộ ranked rows, nên deleted rows có thể làm dịch/tạo gap trong active order và existing deleted hint có thể bị rewrite. File đó đã published tại commit `65e8062` và không được sửa. Initial add-column migration `eb213ce` cũng là historical origin của mixed ranking. Current RPC runtime, partial active-only unique index và active filters thể hiện contract mới rõ hơn.
- Coverage root cause: eval case chỉ supplied hardening SQL; rubric dùng các cụm `preserving existing rows`, `additive ordering` và `corrupt` nhưng không định nghĩa active/deleted/restore domains. Coverage correction bổ sung authoritative ADR context cạnh SQL đã chứa runtime sync function và exact rubric: validate current rows trước khi đề xuất new migration; active relative-order-preserving compaction là hợp lệ; mixed active/deleted ranking, rewrite existing deleted hints, simple un-delete restore và sửa published migration là forbidden; restore reconciliation cùng tests vẫn là separate authorized mutation scope. Không đưa toàn bộ integration-test file vào model package khi ADR + SQL đã đủ contract, không chạy lại/regrade pilot và không thay persisted proposal.
- ASM-PR6 backlog ghi requirement tổng quát, chưa sửa skill: trước ordered soft-delete backfill/constraint change phải xác định riêng active display order, deleted-state retention và restore conflict semantics từ ADR/mutation/tests. ASM-PR6 chỉ được migrate skill sau corrected suite baseline; correction này không cấp migration implementation hoặc acceptance.
- Authority reconciliation: Stage 4 detail từng loại skill/suite semantic changes khỏi default implementation scope. Current owner instruction là exact separately authorized DB-coverage correction theo ASM-PR6 stop rule; master/detail/owner brief được cập nhật để giữ exception hẹp này. CLI behavior, checkpoint boundaries, advisory authority và mọi historical evidence phía trên giữ nguyên.
- Exclusions thực tế: không sửa `.agents/skills/supabase-safe-migration/SKILL.md`, historical SQL, application action/test code hoặc raw pilot files; live/model calls `0`; không database operation, push, PR hoặc merge.
- Deterministic verification trên final suite: `node .agents/scripts/run-skill-evals.mjs validate --skill supabase-safe-migration` đạt `1 skill / 3 suite files / 22 cases / 0 errors / 0 warnings`; `validate --all` đạt `9 / 27 / 187 / 0 / 0`; `node .agents/scripts/validate-skill.mjs` đạt `11 skills / 0 errors / 0 warnings`. Eval-runner regression đạt `130/130`; product evidence tests `npm.cmd run test:run -- __tests__/actions/exercise-authoring-actions.test.ts __tests__/utils/course-readiness.test.ts` đạt `2 files / 41 tests`. Final seven-file UTF-8/no-BOM/final-newline, forbidden skill/migration/app/test diff và `git diff --check` pass. Supabase integration/db reset không chạy vì correction không đổi SQL/runtime và scope cấm database mutation.
- Main-agent formal/integration review đã đối chiếu owner decision → ADR → historical SQL/current RPC → suite context/rubric → ASM-PR6 backlog → append-only history. Review đã sửa hai scope issues trước acceptance: không buộc restore implementation/tests vào migration correction, và không đưa whole integration-test file thừa vào model package; final context dùng authoritative ADR + SQL chứa current RPC. Re-review đạt `0 Critical / 0 Required`, confidence `High`; specialist/fresh-reader `not_run` vì direct deterministic/product evidence đã giải quyết exact semantic ambiguity và không có live authority.

### 7. Stage 4 tooling closure và migration handoff (2026-09-04)

- Owner chốt đủ evidence cho Stage 4 implementation/tooling và yêu cầu “docs only, chốt docs xong commit, push, sau đó tạo pr”. Lượt closure chỉ cập nhật documentation, review rồi commit mới, normal push nhánh Stage 4 và tạo PR vào `main`; không sửa source, skill, suite, SQL hoặc raw evidence, không thêm model/live calls, CI self-fix, merge hoặc migration implementation. Historical local-only/no-remote statements phía trên giữ nguyên nghĩa tại thời điểm được ghi.
- Cơ sở closure là cumulative evidence: corrected six-call pilot ở mục 5 đã chứng minh backend acceptance, bounded dependency waves, same-ref reuse zero dispatch, A-only affected rerun và giữ B success; run mới dưới đây bổ sung evidence trên corrected semantic input. Không cần thêm live call chỉ để làm advisory verdict thành pass. Đây không phải production certification, full-suite pass hoặc human migration acceptance; không thêm checkpoint/lifecycle/behavior requirement và không đổi frozen Stage 3 semantics.
- Latest separately authorized run: `run-25d2635a48444d8388e750cb4f288cd3`, workspace `ws-9cd4dcad7653437995dec00f033ab252`, revision `1`, exact candidate `35cc5a115751412b43253cd100ba6a8df5503af0`, working tree `clean`, candidate-only/no baseline. Chỉ `ssm-reg-additive-constraint-existing-data`; live command duy nhất `patch-check`, dispatch `{ reader: 1, evaluator: 1, total: 2 }`, concurrency `1`, frozen `max_attempts=1`, automatic retry `0`. Cả hai units `succeeded`; không `run`/`resume` hoặc case khác. Đây là quan sát thứ ba trong chuỗi so sánh nhưng mỗi unit là ordinal `1` của run mới; run cũ đã hết budget `2/2`. Grant mới đã consumed, không còn standing live authority.

| Provenance / evidence | Exact value |
| --- | --- |
| `workspace_input_hash` | `97fb96a837e9f90c45356767b9e0c0745db4af4bcc1f01d54ddb41a648e73609` |
| `execution_context_hash` | `5a5f0e2e82b661776653d1ca3ac54a0598eac4c667dc8b5bf1c45a7c14a50732` |
| `attempts/reader-6a35d40b0c421b30c6cc5b8b3a824a9a4088d2dd82c455ad446f4e9b23b21fba/1/output/accepted-observation.json` SHA-256 | `e729aff901490b8f12edf4b79319542c942605cf918658d1298fd8c2724e00a6` |
| `attempts/evaluator-88bb2406df44cb8a1a6dac4e7ae11d6614f85ea959c3eaea77fd0d9cadda459e/1/output/accepted-evaluator-proposal.json` SHA-256 | `89548919d3af4979745cfdb053f93fc5dc4cd9f96b4734182c02df9b2a172230` |

- Evidence paths trong bảng tương đối với run root của CLI store; chỉ concise summary được commit. Raw evidence vẫn transient, không phải durable retention guarantee và không bị copy/rewrite vào repo.
- Latest proposal: criterion `existing-data-safe-constraint-order` có `assessment=partially_satisfied`; veto `migration-breaks-or-corrupts-existing-data` có `veto_assessment=triggered`; report coverage `current`. Reader đề xuất active-only compaction, bảo toàn deleted hints, không sửa published migration và dùng two-phase update. Evaluator còn nhận xét arbitrary tie-breaking khi business order mơ hồ và thiếu explicit restore authorization/reconciliation boundary cùng invalid/ambiguous-data tests. Những nhận xét này cần xác minh thủ công đối chiếu skill/context/rubric trong ASM-PR6, không mặc định là confirmed skill defect hoặc production DB finding. Không sửa skill để chạy lại cho tới khi verdict xanh.
- Ba observations dưới input/contract khác nhau không phải phép đo model variance thuần túy hoặc baseline/candidate comparison. `succeeded`/`current` chỉ xác nhận execution/evidence relation, không xóa advisory veto hoặc tạo human acceptance. Migration preparation có thể tiếp tục; protected semantic acceptance vẫn thuộc existing ASM-PR6 review/comparison gates và [backlog](./structural-migration-roadmap.md#phase-6--asm-pr6--isolated-supabase-migration-and-final-reconciliation).
- Read-only closure verification đã chạy `node .agents/scripts/run-skill-eval-cli.mjs report --run <run-id>` trên cả hai retained runs: `run-ca60fc06d0174a75966330950440b184` trả `22 cases / 2 current / 0 retained_reference / 20 incomplete`; latest run trả `22 / 1 / 0 / 21`. Cả hai mode `patch_check_mixed_revision`, status `incomplete`, exit `1`, dispatch `0/0/0`; complete before/after tree snapshots lần lượt `385` và `161` entries không đổi. Hai latest output hashes khớp bảng trên. Exit `1` phản ánh unrun cases ngoài selected closure, không phải execution failure của selected case.
- Verification currentness: `.agents/scripts/**` và CI workflows không đổi giữa schema checkpoint `0e92e93` và `35cc5a1`; CLI `96/96` và v1 `130/130` là recorded deterministic evidence ở mục 4/5/6, không phải full test rerun của docs closure. Latest report/hash checks ở trên là verification thực tế của closure; không chạy live/model/database operation mới.
- Bounded main-agent docs review: `0 Critical / 0 Required`, confidence `High` cho closure/status/authority reconciliation; không còn unresolved product, architecture, implementation, ownership hoặc acceptance decision trong docs-only scope. Năm file docs đã qua UTF-8/no-BOM/final-newline/fence/conflict/added-secret/added-absolute-temp-path checks, `7` added relative links/anchors và `git diff --check`. Không chạy lại application/full deterministic tests hoặc fresh-reader; đây không phải whole-branch code re-review hay semantic migration approval.
- Delivery snapshot trước docs commit: `origin/main=69e723556088cf885de1d7b2ebe4db29a44180f6`, branch head `35cc5a115751412b43253cd100ba6a8df5503af0`, clean tại preflight, `0 behind / 10 ahead` so với base; exact remote head và PR chưa tồn tại. Owner đã authorize normal push toàn bộ Stage 4 branch và PR creation sau docs review/commit, chưa authorize merge. Subsequent Git/GitHub state và delivery report là bằng chứng cho push/PR thực tế, không suy ra chúng từ quyền đã cấp.

## Current Eval Harness CLI-first implementation

- Historical Stage 4 mixed-budget correction, committed `d5344da` trên baseline `8ba4526`: independently confirmed `1 Required / 2 Suggestions`. Regression qua coordinator/fake worker với ba revision tái hiện budget bị dependency che, không sửa trực tiếp state; trước fix counts là `2 cases / 1 current / 1 retained_reference / 0 incomplete`. Correction ưu tiên `attempt_budget_exhausted` trong shared effective-unit projection; retained proposal vẫn hiển thị nhưng case/report incomplete, exit `1`, counts `2 / 1 / 0 / 1`, report dispatch `0/0/0` và complete run tree không đổi. Execution result cũng phản ánh budget block; test retry ngoài scope xác nhận exit `0`, command `succeeded`, run `prepared`, pending `1`. Guide đã sửa command/run completion và integrity execution/report distinction; CLI master/program plan đã label stale planning metadata là historical và link current authority/status. Full CLI suite `95/95`; source/test syntax và diff/docs hygiene pass. Main-agent formal/integration correction re-review `0 Critical / 0 Required`; không còn decision hoặc contract mismatch chưa giải quyết. Local correction commit theo standing owner policy; không amend/squash. V1 `130/130` và structural `37/37` phía dưới là evidence trước correction, không chạy lại vì không đổi v1/validator. Specialist/fresh-reader `not_run`; S4-CP4 `not_run / unauthorized`, live/model/evaluator calls thật `0`, không remote action.

- Historical Stage 4 implementation checkpoint trước live pilot: owner authorize master/detail implementation và sequential local checkpoint commits sau deterministic verification + formal review `0 Critical / 0 Required` khi diff có ý nghĩa. Correction docs committed `8f424cd`; S4-CP1 committed `e01bb05` (CLI `87/87`), S4-CP2 committed `9e126b6`. S4-CP3 thêm operator guide, đối chiếu command/exit/coverage/authority với source và xác nhận existing Ubuntu CI step đã chạy focused CLI suite; workflow không cần đổi. Cumulative CLI `94/94`, v1 compatibility `130/130`, targeted Stage 4 `15/15` sau directory-snapshot enhancement, structural suite `37/37`, repository validator `11 skills / 0 errors / 0 warnings`, eval catalog `9 skills / 27 files / 187 cases / 0 diagnostics`. Syntax, `git diff --check`, UTF-8/no-BOM/newline/fence/link/conflict và added-line secret-like audits pass. Cumulative main-agent formal/integration review `0 Critical / 0 Required`; không còn mismatch contract đã xác nhận. S4-CP3 accepted và đủ meaningful local commit boundary. Specialist/fresh-reader review `not_run`; không claim Ubuntu/remote CI từ local Windows evidence. S4-CP4 `not_run / unauthorized`. Live/model/evaluator calls `0`; không push/PR/remote action. Các entry planning-only phía dưới là historical snapshots trước instruction implementation mới.

- Historical Stage 4 report-exit correction (committed `8f424cd`): finding mới được xác nhận tại S4-CP2 trên planning commit `c3f08c0`. Detail plan đã thống nhất sau validation: bất kỳ case `incomplete` nào cũng làm report `status = incomplete`, exit `1`, kể cả khi có coherent retained graph; không có case incomplete mới trả `succeeded`/exit `0`; corruption/coverage-invalid vẫn là `command_error`/exit `3`, không report. Regression `O1/E1 → O2/failed` đã bổ sung planned assertions cho case/count/status/exit, dispatch `0` và no mutation. Các review counts trước đó là historical snapshots; bounded main-agent correction re-review hiện đạt `0 Critical / 0 Required`, correction đã commit sau bounded re-review. `git diff --check`, UTF-8/no-BOM/newline/fence, relative-link, conflict-marker và added-line secret-like audits pass; source/runtime tests không chạy vì chỉ sửa docs/regression matrix, fresh-reader `not_run`. Không đổi master/schema/lifecycle/Stage 3/source/test, không chạy model/evaluator/live call.
- Branch/base: Stage 3 `feat/agent-skill-eval-cli-reuse` merged qua PR #80 tại `69e723556088cf885de1d7b2ebe4db29a44180f6`; current Stage 4 branch `feat/agent-skill-eval-cli-evaluator-report` được tạo từ exact merge đó.
- Status: Stage 0 `completed / merged`; Stage 1 `completed / actual CLI gate passed / merged`; Stage 2 `completed / merged`; Stage 3 `completed / supplied correction findings resolved / correction-reviewed / merged`. Historical pre-delivery deterministic evidence: focused Windows `79/79`, v1 compatibility `130/130`, structural validator `37/37`, repository validator `11 skills / 0 errors / 0 warnings`, eval catalog `9 skills / 27 files / 187 cases / 0 diagnostics`, syntax và `git diff --check` pass; fresh formal correction re-review đạt `0 Critical / 0 Required`.
- Historical authority before Stage 4 implementation: bounded Stage 3 status reconciliation, review, docs correction commit và Stage 4 planning đã được authorize. Instruction implementation/local checkpoint mới ở trên supersede hạn chế planning-only của snapshot này; không cấp thêm live hoặc remote authority.
- Target: CLI executor phải chạy được và đạt mục tiêu gốc trước—validate selected static scope/prepare readers trước reader call đầu tiên, finalize evaluator input trước evaluator call tương ứng, giữ independent successes, resume/retry unit-local failures và rerun dependency closure thay vì full run mặc định.
- Architecture: fresh/ephemeral `codex exec`; Stage 1 dùng sequential vertical slice rồi bounded parallel proof trong cùng branch/PR, và chỉ parallel pass mới đạt target architecture. Historical live ceilings, first corrected unknown-outcome attempt và explicit one-time recovery `1 sequential + 2 parallel` đều đã consumed. Recovery gate ngoài host network sandbox cung cấp semantic success mới nhất; prior unknown outcome vẫn được giữ nguyên. Program reuse v1 synthetic packages và local one-writer per-unit state; App Server/native subagent/multi-backend không được build và không block CLI path.
- Boundary: không implement/claim provider-envelope proof, exact call certainty, credential/network/tool-isolation proof, signed evidence, cleanup authority hoặc distributed store. Unit identity, exact input/config hashes, dependency edges và status vẫn bắt buộc vì là functional state của resume/reuse.
- Reuse rule: exact reuse chỉ khi model-visible input/dependencies không đổi. Shared `SKILL.md` change có thể affect mọi reader; affected-only `patch-check` cho vòng sửa nhanh phải được label partial/mixed revision, không giả là complete current-revision run.
- Detailed plans: [CLI-first master plan](./implementation-plans/eval-harness-cli-first/plan.md), [Stage 1 CLI runner plan](./implementation-plans/eval-harness-cli-first/stage-1-cli-runner.md), historical [Stage 2 prepare plan](./implementation-plans/eval-harness-cli-first/stage-2-cli-prepare.md), historical [Stage 3 reuse plan](./implementation-plans/eval-harness-cli-first/stage-3-cli-reuse.md), [Stage 4 evaluator/report plan](./implementation-plans/eval-harness-cli-first/stage-4-cli-evaluator-report.md); decision surface: [owner review brief](./implementation-plans/eval-harness-cli-first/owner-review-brief.md). Bốn supplied Stage 4 `Required` findings ban đầu cùng một finding bổ sung đã được confirmed/corrected tại S4-CP1/S4-CP2, zero-unit `Suggestion` nằm trong regression matrix, và bounded correction re-review là `0 Critical / 0 Required`; đó là historical planning review; implementation authority hiện tại đã được owner cấp và ghi ở trên.
- Stage branches: `Stage 1 feat/agent-skill-eval-cli-runner → Stage 2 feat/agent-skill-eval-cli-prepare → Stage 3 feat/agent-skill-eval-cli-reuse → Stage 4 feat/agent-skill-eval-cli-evaluator-report`; each begins from refreshed `main` after the previous stage merge.
- Concurrency contract: Stage 1 default `4` under explicit operator cap; Stage 2 estimates from unit work, target time, dependency critical path and observed caps. With no trustworthy history, inputs stay `unknown` and recommendation is `min(4, owner/local caps)`.
- Ownership reconciliation: Stage 1 directly consumes existing v1 workspace read helpers without editing packager, and owns its focused deterministic CLI-runner CI step; Stage 4 only extends CI for evaluator/report. This resolves two master-plan ownership inconsistencies without adding backend/hardening scope.
- Stage 2 evaluator correction: Stage 2 owns exact advisory-only `evaluator-proposal-v1`, canonical evaluator stdin/projection, a pure invocation-path-free descriptor compiler and a create-once/exact-replay revision-scoped materializer that returns full non-dispatched path-backed `PreparedUnit`; Stage 3 owns fingerprint/state/reuse; Stage 4 owns evaluator result adapter/scheduling and human/report bridge. Model output không dùng canonical human statuses, winner hoặc action.
- Stage 3 accepted-result correction: master cross-revision reuse requirement đã tồn tại từ Stage 0; planning hiện tại mới chứng minh accepted-result seam thiếu exact accepted-attempt/producing-descriptor anchor. Initial findings `0 Critical / 3 Required`: current compiler rejects an equivalent old-workspace observation through current locator; mutable accepted binding lacks immutable producer SSOT; proposed rule incorrectly attributed `unit_id`/`source_role` to observation fields that do not exist. Corrected contract assigns state I/O/attempt relationship/path containment/producer descriptor resolution to `cli-run-state-v1.mjs`, fingerprint comparison/reuse eligibility to `cli-impact-v1.mjs`, normalized binding/semantic observation validation to the pure compiler, and expanded `accepted_results` descriptor validation to `cli-execution-plan-v1.mjs`. Positive provenance regressions must traverse state reader → impact resolver → compiler. Historical Stage 2 plan remains unchanged; source/test/model/evaluator/live calls in this planning correction are `0`.
- Subsequent Stage 3 plan correction: supplied findings được trace độc lập và xác nhận thêm `0 Critical / 3 Required`. (1) Stage 2 exact `cli_run` v1 cannot accept the draft's renamed/removed fields, nên contract giờ validate v1, create-once/exact-replay zero-attempt bootstrap rồi atomically replace `run.json` last bằng explicit v2 giữ `artifact_type`, `workspace_id`, `status`, `process_settings`, với crash recovery exact v1/v2; later revision plans use explicit execution-plan v2. (2) `attempt.json` freezes terminal status plus output pair matrix: success non-null/non-null, failed/unknown null/null, half-null rejects while consumed ordinal persists. (3) regressions now include valid `variant_mapping` A/B-flip semantic reuse, accepted observation byte immutability, and before/after state + prepared-target snapshots proving every forbidden substitution has evaluator materialization/state mutation `0` through state reader → impact resolver → compiler. Source/test/model/evaluator/live calls remain `0`; Stage 3 implementation remains unauthorized.
- Historical Stage 3 transferable-contract correction: all four supplied findings were independently confirmed `Required`. Full `active_attempt` identity/ordinal/producer revision/paths were frozen before spawn; recovery preserves valid terminal results, creates recovery-only `outcome_unknown` only when no result/record exists, and integrity-blocks contradictory evidence without fake relationships or extra ordinals. Unit fingerprint/binding nullability, lexical exact dependency-binding equality, persisted-integrity versus derived-dependency blocking, public envelopes/status/exit behavior and Stage 3-owned v2 scope were frozen. At that planning checkpoint source/test/model/evaluator/live calls remained `0` and implementation authority was absent; current implementation state is recorded above.
- Historical continuation Stage 3 contract correction: four follow-up findings were independently confirmed `Required`. Master/detail separated valid behavior/binding invalidation from corrupt accepted evidence, restricted persisted integrity block to coordinator-owned in-flight recovery contradictions, froze the operational latch, canonical v1 read-only status, patch-check mixed-mode lifecycle and all-or-nothing multi-unit validation. At that planning checkpoint source/test/model/evaluator/live calls remained `0` and implementation authority was absent; current implementation state is recorded above.
- Historical final Stage 3 transferability correction: two findings were independently confirmed `Required`. Frozen `max_attempts` became a run-wide lifetime ceiling across revisions/fingerprints; patch-check received an exact projected status/dependency/budget matrix; recognized `operational_condition` remained strictly pre-spawn with command-error dispatch `0`. At that planning checkpoint source/test/model/evaluator/live calls remained `0` and implementation authority was absent; current implementation state is recorded above.
- Stage 3 implementation evidence: CP0 binds every accepted result to immutable attempt/result/output plus producing revision descriptor; CP1 adds strict v2 run/unit/attempt state, v1 bootstrap and revision recovery; CP2 adds canonical `run`/read-only `status`, reader attempts, evaluator preparation and all restart windows; CP3 adds `resume`, atomic explicit `retry`, pure startup projection and the persisted operational latch; CP4 adds impact closure and `patch_check_mixed_revision`; CP5 cumulative review corrected next-revision invalidation/public prepare snapshots. The supplied post-CP5 reviews independently confirmed six initial, three subsequent và two latest `Required` findings. Correction now (1) waits for every started worker before response with actual spawn evidence, (2) preflights every patch-check before mutation, (3) derives `run`/`resume`/`retry` affected IDs from shared canonical unit classification while `patch-check` returns its exact downstream closure, (4) emits `CLI_ATTEMPT_BUDGET_EXHAUSTED` for retry exhaustion, (5) keeps valid retry startup-recovery projection in memory until preflight succeeds, (6) publishes mixed mode as patch-check's first standalone mutation before v1 bootstrap or unpublished-next recovery and preserves it through exact transitional recovery, (7) rejects valid-looking transitional unit inventory bound to another run, (8) reconciles current status/authority sources and (9) updates the test-plan header. Post-correction gates pass at focused `79/79`, v1 `130/130`, structural `37/37`, repository `11/0/0`, catalog `9/27/187/0`, syntax/diff/scope/conflict/secret scans; fresh formal correction re-review is `0 Critical / 0 Required`. Deterministic fake/local temp adapters only; evaluator dispatch, installed Codex invocation, network, model/provider/live calls all remain `0`.
- Model-input correction: raw v1 bundle/context manifests remain validate-only provenance and are absent from bounded model-visible input/fingerprint; exact canonical `requested_execution_policy` is embedded in deterministic stdin after source-policy-to-suite equality validation. Blind reader-generated framing/path/metadata does not reveal semantic role or opaque mapping; copied reader payload is not substring-scanned or rewritten. Evaluator input may carry semantic `candidate`/`baseline` roles required for comparison but excludes opaque `A/B`, mapping and provenance identities. This is Option 1 and adds no policy artifact/schema/module.
- CI cleanup: commit `0d30904` removes only three specialized CP8A/CP8B/CP9 steps from default CI; generic harness, source tests and manual commands remain. PR #77 evidence showed `Test and Build` `10m23s`, with CP9 as the long-running specialized step.
- Design-change rule: material CLI/state/reuse/command/stage/live-call/report change requires research, owner notification/confirmation, plan update and re-review before implementation; no silent hardening.
- Prior three-finding correction review: pure compilation now returns invocation-path-free `PreparedUnitDescriptor`, Stage 2 owns revision-scoped materialization to the path-backed worker contract, blindness is scoped to reader-visible input while evaluator semantic roles remain allowed, and the stale Stage 1 gate is closed. Self-review additionally found and resolved the CP4/CP5 ordering dependency by allocating an unpublished run/revision root before materialization and publishing plan artifacts only after the barrier succeeds. Its initial `0 Critical / 0 Required` verdict was superseded by the later replay-safety finding recorded next.
- Replay-safety correction review: the supplied post-publish/pre-state crash-window finding was independently confirmed. Materialization is now create-once/exact-replay: an existing final target is accepted only after exact inventory/path/regular-file/bytes/hash plus descriptor projection/`cli_options` validation; partial or mismatched targets remain fail-closed and immutable. `run`/`resume` regenerate descriptors only from persisted current-revision inputs and frozen CLI options. Stage 2 owns exact-replay/mismatch unit regressions; Stage 3 owns the crash-after-publish integration proving `resume` reconstructs the same `PreparedUnit`, persists state once and creates no overwrite or duplicate dispatch. Affected-doc link/fence/UTF-8/newline/scope/replay-contract/secret-marker checks and `git diff --check` pass; terminal working-diff review `0 Critical / 0 Required`. Source, suite and CI files are unchanged, so the already-recorded `26/26` runner and `9/27/187/0` catalog results were not needlessly rerun; no source/test implementation and model/live calls `0`.
- Portability correction review: Node standard `fs.rename`/`renameSync` does not expose `RENAME_NOREPLACE`, while Linux directory rename may replace an existing empty destination; the prior atomic no-replace wording was therefore not implementable portably across Windows local and Ubuntu CI. Publication now relies explicitly on the existing one-coordinator/one-writer boundary: validate same-filesystem staging, precheck destination, rename only when absent, exact-replay validate when already present or after rename failure, and revalidate after success. External/multiple-writer injection, native/platform-specific primitives and publication-lock recovery remain outside scope. Stage 2 regressions must run on Windows local and Ubuntu CI for new publish plus existing complete/partial/mismatched target and replay behavior. Affected-doc scope/link/fence/UTF-8/newline/contract/secret-marker checks and `git diff --check` pass; terminal working-diff review `0 Critical / 0 Required`. Source, suite and CI files are unchanged, so the recorded `26/26` runner and `9/27/187/0` catalog results were not rerun; model/live calls `0`. No Stage 2 implement plan/source/test implementation has started at this correction point.
- Stage 2 detailed-plan draft: [stage-2-cli-prepare.md](./implementation-plans/eval-harness-cli-first/stage-2-cli-prepare.md) freezes the import-safe bounded v1 prepare export, all-scope reader/evaluator static compiler, fixed OS-temp CLI run root, exact proposal/descriptor contracts, `run.json`-last publication marker, portable replay-safe materializer, nullable unknown estimate and CP1–CP5 verification/stop gates. First self-review corrected evaluator-static-plan checkpoint ownership and removed an ambiguous v1 main/export choice; second pass added exact stdin-derived projection inventory and coordinator-side dependency locator binding. Its reported `0 Critical / 0 Required` verdict was superseded by the supplied-finding review recorded next. Source/test implementation and model/evaluator/live calls remain `0`; owner approval is pending.
- Supplied Stage 2 detailed-plan finding review: không trust verdict có sẵn; trace độc lập xác nhận `0 Critical / 3 Required`. Correction (1) áp formal `0 Critical / 0 Required` gate cho từng S2-CP1–S2-CP5, với CP4 integration và CP5 cumulative review bổ sung; (2) freeze exact `selected_scope`, reader/evaluator lists, counts, ready set, waves, run/unit IDs, success/error output, validator relationships và estimate status/null matrix với all-or-nothing history; (3) thêm Stage 2 vào artifact index và reconcile một current authority statement—`0cb0099`/`19a64eb` đã consume commit grants, không có thêm commit/source/remote grant. Main-agent correction re-review `0 Critical / 0 Required`; owner approval vẫn pending, fresh-reader `not_run`, source/test/model/evaluator/live calls vẫn `0`.
- Subsequent full re-review findings: không trust verdict có sẵn; trace source/schema/test xác nhận thêm `0 Critical / 3 Required`. Correction preserves v1 `cases: []` semantics and freezes empty/mixed/zero-unit artifacts, changes null error locators from false allocation certainty to caller-knowledge unavailable, and limits routine checkpoint documentation to `progress.md` while master/detail/owner-brief/README use exact conditional triggers outside the default implementation diff. Targeted existing empty-suite regression passes `1/1`; affected-doc contract/link/fence/UTF-8/no-BOM/newline/conflict/secret/scope checks and `git diff --check` pass. Main-agent correction re-review `0 Critical / 0 Required`; owner approval remains pending, fresh-reader `not_run`, source/test implementation and model/evaluator/live calls remain `0`.
- Zero-unit arithmetic correction review: supplied finding được đối chiếu như hypothesis và xác nhận `0 Critical / 1 Required`: detailed plan vừa yêu cầu complete-history zero-unit aggregates bằng `0`, vừa đòi mọi non-null duration/time phải positive. Correction giữ leaf inputs `duration_seconds[*].seconds` và non-null `target_wall_time_seconds` positive finite; cho `total_work_seconds`, `dependency_critical_path_seconds` và `estimated_wall_time_seconds` non-negative finite; freeze complete-history zero-unit with target thành `concurrency_for_target = 0`, `recommended_concurrency = 1`, còn `planned_concurrency` luôn positive theo explicit/fallback rule. Estimate test matrix đã khóa target-present/target-absent controls. Chỉ detailed plan và current progress source đổi trong correction này; master, owner brief và README không có ownership trigger. Terminal main-agent re-review `0 Critical / 0 Required`; source/test files unchanged nên không rerun source tests, fresh-reader `not_run`, source/test implementation và model/evaluator/live calls vẫn `0`.
- Stage 0 delivery: PR #77 checks `Test and Build`, `production-gate`, `Vercel` và `Vercel Preview Comments` passed; merged at `e195569479ee49dd9592a93573c49ecad85cd9e6`. Stage 1 plan research used only code/docs and non-model `codex --version`/`codex exec --help` probes; model/provider calls `0`.
- Stage 1 deterministic implementation: new `execute-prepared` CLI, v1 selected-workspace adapter, semantic reader identity/projection, blind bounded input package, exact Codex argv/stdin process adapter, conservative outcome mapping và bounded worker pool đã implement. Focused fake-process suite hiện đạt `26/26` trên Node `v24.11.1`; ngoài các proof gốc, correction tests khóa canonical stdin envelope chứa lossless full bundle/selected prompt/context/exact policy, fake child chỉ derive behavior từ stdin, bundle-byte/policy fingerprint dimensions, invalid UTF-8 dừng trước preflight với `0` dispatch/no execution root, và valid UTF-8 BOM được giữ lossless. Timeout/interruption dùng `SIGTERM` → finite grace → `SIGKILL` → finite forced settlement; local Windows regression đã quan sát bounded settlement, còn POSIX fake child bỏ qua `SIGTERM` đã được wire để Ubuntu CI buộc hard-termination path nhưng remote CI chưa chạy. Syntax checks, CLI `--help`, repo skill validator và `git diff --check` thuộc final deterministic command set của checkpoint này. CI có đúng một focused step `node --test .agents/scripts/run-skill-eval-cli.test.mjs`; CP8A/CP8B/CP9 specialized steps vẫn absent. Correction self-review tìm `0 Critical / 1 Required` về UTF-8 BOM round-trip và đã sửa. Final audit sau live recovery tìm `0 Critical / 2 Required`: frozen ceiling chưa ghi post-failure owner override và test header còn stale `24`; cả hai đã được reconcile, affected-only gate rerun đạt, terminal correction review `0 Critical / 0 Required`. Implementation gốc đã commit local tại `49b8777`; live result và semantic blocker được ghi riêng bên dưới.
- S1-CP5 exact live result: owner-authorized `gpt-5.6-sol / medium` gate dùng đúng `1` sequential reader tại concurrency `1`, rồi `2` distinct readers trong một command concurrency `2`; CLI `0.149.1`, reader/evaluator/retry calls `3 / 0 / 0`. Sequential execution `exec-989a8422e301449ba5a0e4bcd4b25565` đạt process/schema `1/1 succeeded` trong `50224ms`. Parallel execution `exec-fdf0395b0a21479d9b32906005fa0af2` đạt process/schema `2/2 succeeded`; hai process overlap khoảng `32.93s`, durations `32943ms` và `43611ms`. Exact unit IDs là `reader-bd5e21145011388e46085322a7a8196fb376c25bbe6a2abb5014cdd021cd7d8d`, `reader-795e43d3b5c4b776f3cf63d3d3806a308f550f4d3a5de552cdebc5ef1e857759` và `reader-1ccbf9acd4942b2fffc257cff2fd192d26682079b2b7e44f4c292277eac2cde4`. Tuy nhiên cả ba accepted observations đều báo semantic task không thể hoàn thành: canonical policy yêu cầu `filesystem: package_read_only` nhưng `tools: none`, trong khi Codex CLI chỉ có thể đọc `bundle/SKILL.md`, `case/prompt.txt` và schema qua tool/process; mọi read attempt bị policy chặn trước execution. Vì vậy transport/schema evidence không được nâng thành semantic canary success; Stage 1 dừng theo installed-CLI/package-consumption stop condition với `STOP / design_change_required`. Không retry, evaluator, extra calibration hoặc call thứ tư; raw evidence chỉ giữ transient trong OS temp.
- Approved Stage 1 design correction: suite policy không đổi; blocker thuộc file-acquisition assumption của CLI adapter. Delivery mode mới `stdin_embedded_executor_input_v1` compile exact validated requested policy cùng lossless strict-UTF-8 full bundle, selected prompt/context into one blind canonical stdin envelope; invalid UTF-8/round-trip mismatch fails before spawn, no base64/chunk/repair. Attempt-local copies remain diagnostic only. Existing behavior projection shape remains; `stdin_sha256` covers exact transmitted envelope and `model_visible_files` inventories embedded logical payload hashes. Deterministic fake child derives task behavior solely từ stdin và không đọc package filesystem; focused suite đạt `26/26`. Original corrected live gate contract là exactly one command với `2` distinct readers tại concurrency `2`, evaluator/retry `0`, no repeated sequential/full batch; command đó đã thực thi một lần và kết thúc unknown. Owner decision sau failure cấp one-time `1 sequential + 2 parallel` recovery exception; decision, original result và recovery result được giữ tách biệt bên dưới.
- Corrected S1-CP5 exact result: owner-authorized command chạy workspace `ws-67d1c44c680f4ede8d75eb7d2d85700f`, units `candidate:fresh-reader:gcw-fresh-push-explicit` và `candidate:fresh-reader:gcw-fresh-correction-no-amend`, requested/effective concurrency `2`, CLI `0.149.1`, execution `exec-166248fe0d3548718fb5cdffd7af5343`. Hai process start cách nhau `11ms` và cùng settle sau khoảng `120s`; counts `0 succeeded / 0 failed / 2 outcome_unknown`. Exact unit IDs là `reader-795e43d3b5c4b776f3cf63d3d3806a308f550f4d3a5de552cdebc5ef1e857759` và `reader-1ccbf9acd4942b2fffc257cff2fd192d26682079b2b7e44f4c292277eac2cde4`. Cả hai event stream có `thread.started` và `turn.started`, sau đó WebSocket và HTTPS đều bị host network refusal `os error 10013`; không có model last-message/accepted observation để semantic-inspect. Provider-call outcome therefore remains unknown; harness retry `0`, evaluator `0`, không redispatch. Corrected gate authority đã consumed và Stage 1 giữ `STOP / input_correction_live_canary_outcome_unknown`.
- S1-CP5 recovery result: owner explicitly reauthorized old-process audit plus one new sequential and one new two-reader parallel command. Exact command-line audit found no prior live-call process, so kill count `0`. Sequential execution `exec-7393dc8ca69142b4b1912391eeb9aea0` ran `candidate:fresh-reader:gcw-fresh-commit-local-only` at concurrency `1`; unit `reader-bd5e21145011388e46085322a7a8196fb376c25bbe6a2abb5014cdd021cd7d8d` succeeded in `25827ms`, observation SHA-256 `70e3c5d3442ea9372a6928f6995b45d274840cfc5cfa1addc6920f4a9c2d1364`. Human semantic inspection confirmed exact local-commit-only/no-push procedure, no invented execution and stdin-only consumption. Parallel execution `exec-f7bb74ef3bcd478aaa95b7a57911d632` ran the two corrected units at requested/effective concurrency `2`; processes started `14ms` apart, overlapped about `18.81s`, and succeeded in `18822ms` plus `23231ms`. Observation hashes are `7184c1586e719792508b681094491f5bd2d8c568e35578279ef189e2c03633be` and `efc4a71010f15c0d7150142615360ce668c5c3aae861815772428667c9ce79c0`. Semantic inspection confirmed exact normal-push-only/no PR-CI-force-push behavior and exact new-correction-commit/no amend-squash-rebase-reset-push behavior; both report no invented execution and stdin-only consumption. Recovery counts `3 succeeded / 0 failed / 0 outcome_unknown`, evaluator/harness retry `0`; Stage 1 actual-CLI completion gate passes while the earlier unknown outcome remains preserved.
...
- Authority: every historical CP9 live-call/probe/readmission authority is consumed. Owner decision ngày `2026-08-30` authorized truthful CP9 no-go closure, CP10 reconciliation, PR creation and CI watching; a later explicit instruction authorized merge if CI passed and was consumed by PR #76. Those historical permissions do not authorize another live call, CP9 repair, CLI implementation, deploy, history rewrite or branch deletion.
- Stage status: Stage 1 CP1–CP4 is `completed / delivered`; Stage 2 CP5–CP7 is `completed / delivered`; Stage 3 CP8A is `completed` at `f9c821323ae5e8aa277d2cd68d4b416d80cf553e`; CP8B is `CP8B_CLOSURE_ACCEPTED` at `19cd324b7a0fd1509bddf441a2572360013e72f5`; CP9 is `completed_with_no_go / architecture_superseded`; CP10 is `completed / delivered` at `0 Critical / 0 Required` through merged PR #76, merge commit `16bf80babd129fb42572603c7204e7c368aa3e67`.
...
- CP8B implementation evidence at that checkpoint: immutable creation plus append-only lifecycle/holds, retain-first global-CAS planning, exact-plan recoverable apply, separate purge/tombstones, deterministic mock-only shadow ownership/reconciliation, representation metadata/rebuild and read-only v1 inventory are implemented. The four CLI forms and deterministic CP8A/CP8B CI steps are wired; operator workflow is documented in `eval-design.md`. Exactly 18 frozen contracts passed as `24/24` assertions; v2 `132/132`, CP8A `93/93`, v1 `130/130`, structural `37/37`, repository `11/0/0`, catalog `9/27/187/0`, syntax/CLI/diff/hygiene passed. Live calls were `0`; CP9 live execution and CP10 had not started at that historical checkpoint.
...
- CP10 closure evidence: local cumulative review completed at `0 Critical / 0 Required`. Final deterministic rerun passed structural `37/37`, v1 `130/130`, v2 `136/136`, CP8A `115/115`, CP8B `24/24`, CP9 `60/60`, repository `11 / 0 / 0` and catalog `9 / 27 / 187 / 0 / 0`; changed-test syntax and `git diff --check` passed. CP8B's previously recorded `20/24` expiry Advisory was resolved by replacing calendar-expired fixture timestamps with one run-relative test epoch, and the CP9 retained-v1 regression now uses its exact historical schema hashes rather than current admission hashes. Both corrections are test-only; production runtime behavior and terminal CP9 evidence are unchanged. Targeted ESLint has `0 errors`; CP8B retains three non-blocking existing unused-symbol warnings and CP9 is clean. Added-line secret/conflict scans are `0 / 0`. No new fresh reader ran because CP10 introduced no semantic skill behavior. PR #76 required CI passed and the workstream merged at `16bf80babd129fb42572603c7204e7c368aa3e67`.
