...
- Authority: current owner authority covers only the bounded CP9 R4 regression-semantics correction and exactly one local correction commit after terminal `0 Critical / 0 Required`. Pilot execution, provider/model/reader/evaluator/helper/subagent calls, push, PR/CI/merge/deploy, history rewrite and CP10 remain unauthorized.
