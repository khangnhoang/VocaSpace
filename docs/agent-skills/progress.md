...
- Current authority: owner đã yêu cầu cleanup CI riêng, lập/self-review/commit/normal-push Stage 1 plan. Quyền này không cấp Stage 1 implementation, live call, PR, CI-fix hoặc merge.
