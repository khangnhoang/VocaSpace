...
**ASM-PR1, ASM-PR2A–ASM-PR2C, ASM-PR3, ASM-PR4, ASM-PR5A và ASM-PR5B đã merge; PR #73 merged ASM-PR5B tại `effb5571955aa09b714e97b7162a6bb3bed0bca4`. Current workstream là Agent Skill Eval Harness hardening trên `refactor/agent-skill-eval-harness`; Stage 1 (`CP1–CP4`) và Stage 2 (`CP5–CP7`) đã completed/delivered, Stage 3 CP8A đã completed, CP8B đã closed với `CP8B_CLOSURE_ACCEPTED`, và CP9 R1–R4 remain closed. Runtime-policy decision is `GLOBAL_ONLY`; new preparation binds global `gpt-5.6-sol / medium` with exact `config_sha256=6f38a9f22d10b5fa430637ce5be6a586f5728c000727141afb20be2a4f79bcf4`, helper budget `0`, no escalation role and calls `0`. Failed authorized pilot attempt vẫn dừng trước `reader-canary`; CP9 cần independent runtime-policy re-audit và sau đó có separate live authorization. CP10 chưa bắt đầu.**
...
- Authority: current owner authority covers only the bounded CP9 runtime model-policy feasibility/correction pass and exactly one local correction commit after terminal `0 Critical / 0 Required`. Pilot execution, provider/model/reader/evaluator/helper/subagent calls, push, PR/CI/merge/deploy, history rewrite and CP10 remain unauthorized.
