...
| D1 — Topic authoring → review → publication | [d1/plan.md](./d1/plan.md) | — Owner request là decision source; không tạo brief trùng lặp | Implementation local P0–P4 + correction đã đạt; chưa push/PR |
