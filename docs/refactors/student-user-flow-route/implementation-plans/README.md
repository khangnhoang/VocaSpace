...
| C2 — Workspace route hardening | [c2/plan.md](./c2/plan.md) | [c2/owner-review-brief.md](./c2/owner-review-brief.md) | Đã merge qua PR #96 (`3a95c310`); implementation/browser/build/CI gates đạt |
