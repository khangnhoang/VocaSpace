...
Các plan lịch sử trong `../plans/` được giữ tại chỗ cho PR đã hoàn tất. B3 đã được migrate vào hierarchy này; file B3 cũ không còn là một source song song. C1/C2/D1/Q7 là execution contract đã triển khai. Delivery status/evidence vẫn thuộc [progress.md](../progress.md), risk/constraint thuộc [problems.md](../problems.md); index này không tự cấp implementation hay remote authority.
