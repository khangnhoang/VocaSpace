...
| D1 — Topic authoring → review → publication | [d1/plan.md](./d1/plan.md) | — Owner request là decision source; không tạo brief trùng lặp | Earlier P0–P4 + correction đã đạt local; amended P0-A/P1-A/P2-A đã PASS local, tiếp tục `P3-A → P4-A`; chưa push/PR |
