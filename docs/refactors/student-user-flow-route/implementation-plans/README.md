...
| --- | --- | --- | --- |
| B3 — Redirect public detail cũ | [b3/plan.md](./b3/plan.md) | [b3/owner-review-brief.md](./b3/owner-review-brief.md) | Planning package đã tự review; implementation chưa bắt đầu và chưa được phép bắt đầu |
