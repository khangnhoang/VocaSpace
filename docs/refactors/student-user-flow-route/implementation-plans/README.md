...
| Q7 — Internal previewer access correction | [q7/plan.md](./q7/plan.md) | — Owner decisions được ghi trong detail plan | Đã merge qua PR #101 và rollout production; xem [progress.md](../progress.md) |
| D2 — Public topic preview | [d2/plan.md](./d2/plan.md) và [d2/design.md](./d2/design.md) | — Owner decisions nằm trong master plan và detail plan | Contract đã chốt; local implementation và independent review `PASS` tại `39feb3a`; xem [progress.md](../progress.md) cho evidence và delivery boundary |

Các plan lịch sử trong `../plans/` được giữ tại chỗ cho PR đã hoàn tất. B3 đã được migrate vào hierarchy này; file B3 cũ không còn là một source song song. C1/C2/D1/Q7/D2 là execution contract đã triển khai; D2 mới hoàn tất cục bộ, chưa có bằng chứng push/PR/merge/deploy. D3 là candidate kế tiếp theo working execution order, chưa có detail plan hay implementation authority từ mốc D2. Delivery status/evidence vẫn thuộc [progress.md](../progress.md), risk/constraint thuộc [problems.md](../problems.md); index này không tự cấp implementation hay remote authority.
