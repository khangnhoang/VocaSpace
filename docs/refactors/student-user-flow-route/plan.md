...
Mỗi Wave D candidate chưa triển khai cần implementation brief và Owner acceptance riêng trước khi code; D1 đã merge qua PR #98 và Q7 đã merge/rollout qua PR #101. [Canonical D1 detail plan](./implementation-plans/d1/plan.md) sở hữu contract D1; [Q7 detail plan](./implementation-plans/q7/plan.md) sở hữu contract Q7; D2 vẫn cần unit contract và authority riêng, còn D6 trở đi giữ deferred/open cho đến khi làm tới và có acceptance tương ứng. Quyết định Owner lịch sử của D1/Q7 không tự cấp quyền cho follow-up mới.
