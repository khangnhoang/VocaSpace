...
| PR D1: Topic authoring → review → publication (`FUTURE-PUBLISH-001`) | Earlier local implementation P0–P4 và fresh-reader corrections đã đạt; amended P0-A/P1-A đã PASS local, P2-A/P3-A/P4-A còn mở | C2 PR #96 đã merge | `feat/topic-publish-validation`; local-only implementation; latest amendment commits đang được tạo theo checkpoint | 2026-09-16 | Historical P0–P4 evidence vẫn giữ cho contract trước amendment. D1 tiếp tục `P2-A → P3-A → P4-A` cho group-scoped content writes, transfer feedback/UI và create-result navigation regression; browser/fixture/service-role và repository-wide lint residual vẫn được ghi rõ. |
...
| --- | --- | --- |
| D1 — Topic authoring → review → publication | Earlier P0–P4 đã có readiness/review foundation, trusted lifecycle boundary, content mutation safety, workflow UX và closure local; amended P0-A/P1-A đã PASS local trên branch này; P2-A content bridge, P3-A navigation/UX và P4-A closure còn mở. | Tiếp tục tuần tự `P2-A → P3-A → P4-A`; chưa handoff review/push/PR cho amended contract; không mở rộng sang Q7/D2/candidate revision. |
