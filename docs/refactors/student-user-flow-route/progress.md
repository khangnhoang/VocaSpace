...
| Wave D: Later backlog | D1 đã merge; Q7 đã rollout production; D2 C1–C5 có local checkpoints, C6 đang tiếp tục | Stable route/dashboard/workspace contracts | D1 PR #98; Q7 PR #101, merge `65e8481`; working execution order trong [plan.md](./plan.md) | 2026-09-24 | Q7 hoàn tất gate rollout trong phạm vi đã xác minh; D2 chưa đạt integrated acceptance/rollout. D6–D9 deferred/open về detailed acceptance. |
...
| D2 — Preview topic contract | `C1–C5` đã triển khai, kiểm tra và commit cục bộ; `C6` chưa hoàn tất. Public syllabus links và stateless Preview experience đã mở trên local branch; integrated acceptance/rollout chưa đạt. | [D2 detail plan](./implementation-plans/d2/plan.md) và [thiết kế](./implementation-plans/d2/design.md) sở hữu contract; mỗi checkpoint có evidence và commit cục bộ riêng. |
...
- D1 đã merge qua PR #98; Q7 đã merge và rollout theo bằng chứng bên dưới. D2 C1–C5 đã có local implementation checkpoints; C6 chưa hoàn tất nên D2 chưa đạt integrated acceptance hoặc rollout. D3–D5 còn semantic decisions riêng, còn D6–D9 giữ deferred/open về detailed acceptance và sẽ quyết định khi làm tới.
