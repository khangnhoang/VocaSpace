...
| Wave D: Later backlog | D1 đã merge; Q7 đã rollout production; D2 C1–C6 đã đạt local implementation và integrated acceptance | Stable route/dashboard/workspace contracts | D1 PR #98; Q7 PR #101, merge `65e8481`; D2 local branch `feat/student-flow-d2-public-preview`; working execution order trong [plan.md](./plan.md) | 2026-09-24 | D2 chưa rollout; cần preflight inventory trên môi trường đích. D6–D9 deferred/open về detailed acceptance. |
...
| D2 — Preview topic contract | `C1–C6` đã triển khai, kiểm tra và commit cục bộ. Public syllabus, stateless Preview và quota recovery đã qua integration/browser acceptance trên local branch; chưa rollout. | [D2 detail plan](./implementation-plans/d2/plan.md) và [thiết kế](./implementation-plans/d2/design.md) sở hữu contract; từng checkpoint có evidence và local commit riêng. |
...
- D1 đã merge qua PR #98; Q7 đã merge và rollout theo bằng chứng bên dưới. D2 C1–C6 đã có local implementation checkpoints; integrated acceptance đạt bằng integration và browser automation cục bộ, còn rollout chưa được thực hiện. Trước rollout cần kiểm tra lại creator và managed-media inventory trên môi trường đích. D3–D5 còn semantic decisions riêng, còn D6–D9 giữ deferred/open về detailed acceptance và sẽ quyết định khi làm tới.
