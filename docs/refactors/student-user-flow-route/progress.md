...
| Q7 — Internal previewer access correction | Đang triển khai: P0 freeze đã commit; P1 read/private-media local checkpoint đạt sau self-review, P2–P3 chưa hoàn tất. | Sau D1 và trước D2; sửa previewer-only read/media boundary cùng enrollment gate cho Action và direct Data API, giữ DB-wide relation/correctness invariants khác trong `LEARNING-INTEGRITY-001`. |
