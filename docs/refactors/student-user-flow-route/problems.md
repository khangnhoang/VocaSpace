...
- Trạng thái vấn đề: Open; detailed plan đã hoàn tất, D1 P0–P4 và correction sau fresh-reader đã triển khai trên branch local. Các giới hạn fixture/browser và service-role guarantee vẫn là risk/follow-up, không phải Owner-decision blocker.
