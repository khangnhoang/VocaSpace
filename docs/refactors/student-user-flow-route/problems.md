...
- Trạng thái vấn đề: Open; detailed plan đã hoàn tất, D1 P0–P4 và correction units sau fresh-reader đã triển khai trên branch local, correction commits `143102e`, `c56f3aa`, `65ed00d`, `6180356`. Full Vitest `51 files / 446 tests` và full integration `12 files / 117 tests` đều đạt; các giới hạn fixture/browser và service-role guarantee vẫn là risk/follow-up, không phải Owner-decision blocker.
