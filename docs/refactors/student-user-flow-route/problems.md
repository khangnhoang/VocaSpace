...
- Trạng thái vấn đề: Open; P0-A/P1-A/P2-A đã triển khai và pass local trên branch D1, P3-A/P4-A còn mở.
...
- Ảnh hưởng còn mở: P2-A đã đóng content/card/exercise/child/media group boundary và direct-trigger TOCTOU; P3-A còn phải làm discoverable transfer feedback và kiểm chứng create navigation. Các invariant schema/transfer/reviewer exclusion của P0-A/P1-A và content boundary của P2-A đã có local evidence.
- Hướng xử lý: P0-A đã thêm minimal authorship schema/history/fixture backfill policy; P1-A đã đóng trusted group/transfer/leave/request boundary, reviewer exclusion, reviewer-safety và locking; P2-A đã đóng content-write authorization, legacy RPC bypass và direct-trigger TOCTOU. Tiếp tục P3-A cho UI/feedback/navigation; P4-A cho invariant/concurrency/browser evidence. Không dùng reviewer delegation boolean để thay thế authorship relation.
