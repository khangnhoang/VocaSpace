...
- Open after P1: published edit/delete/restore atomic demotion và full content mutation bridge thuộc P2; teacher/admin workflow UX và browser/manual closure thuộc P3/P4. Đây là residual scope, không phải P1 blocker.
